...
#endif /*VK_USE_PLATFORM_WIN32_KHR*/
#if defined( VK_USE_PLATFORM_ANDROID_KHR )
    eNativeBufferANDROID = VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID,
    eSwapchainImageCreateInfoANDROID = VK_STRUCTURE_TYPE_SWAPCHAIN_IMAGE_CREATE_INFO_ANDROID,
    ePhysicalDevicePresentationPropertiesANDROID = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_ANDROID,
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
;
  ...
  enum class SwapchainImageUsageFlagBitsANDROID : VkSwapchainImageUsageFlagsANDROID
  {
    eShared = VK_SWAPCHAIN_IMAGE_USAGE_SHARED_BIT_ANDROID
  };

  using SwapchainImageUsageFlagsANDROID = Flags<SwapchainImageUsageFlagBitsANDROID>;


  template <> struct FlagTraits<SwapchainImageUsageFlagBitsANDROID>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
    static VULKAN_HPP_CONST_OR_CONSTEXPR SwapchainImageUsageFlagsANDROID allFlags =
          SwapchainImageUsageFlagBitsANDROID::eShared;
  };
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
  ...
  template <> struct FlagTraits<VideoEncodeH264CapabilityFlagBitsEXT>
  {
    ...
    static VULKAN_HPP_CONST_OR_CONSTEXPR VideoEncodeH264CapabilityFlagsEXT allFlags =
        ...
        | VideoEncodeH264CapabilityFlagBitsEXT::eDifferentReferenceFinalLists;
  };
