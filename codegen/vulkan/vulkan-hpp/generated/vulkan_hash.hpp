...
template <> struct hash<VULKAN_HPP_NAMESPACE::MetalSurfaceCreateInfoEXT>
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::NativeBufferUsage2ANDROID>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NativeBufferUsage2ANDROID const & nativeBufferUsage2ANDROID) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferUsage2ANDROID.consumer );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferUsage2ANDROID.producer );
      return seed;
    }
  };
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::NativeBufferANDROID>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::NativeBufferANDROID const & nativeBufferANDROID) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.sType );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.handle );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.stride );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.format );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.usage );
    VULKAN_HPP_HASH_COMBINE( seed, nativeBufferANDROID.usage2 );
      return seed;
    }
  };
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePortabilitySubsetPropertiesKHR>
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDevicePresentationPropertiesANDROID>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDevicePresentationPropertiesANDROID const & physicalDevicePresentationPropertiesANDROID) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, physicalDevicePresentationPropertiesANDROID.sType );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDevicePresentationPropertiesANDROID.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, physicalDevicePresentationPropertiesANDROID.sharedImage );
      return seed;
    }
  };
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
template <> struct hash<VULKAN_HPP_NAMESPACE::SurfaceFullScreenExclusiveWin32InfoEXT>
  ...
  #if defined( VK_USE_PLATFORM_ANDROID_KHR )
template <> struct hash<VULKAN_HPP_NAMESPACE::SwapchainImageCreateInfoANDROID>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::SwapchainImageCreateInfoANDROID const & swapchainImageCreateInfoANDROID) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    VULKAN_HPP_HASH_COMBINE( seed, swapchainImageCreateInfoANDROID.sType );
    VULKAN_HPP_HASH_COMBINE( seed, swapchainImageCreateInfoANDROID.pNext );
    VULKAN_HPP_HASH_COMBINE( seed, swapchainImageCreateInfoANDROID.usage );
      return seed;
    }
  };
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
