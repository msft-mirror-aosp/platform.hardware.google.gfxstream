...
./build/gfxstream-generic-apigen -i ./codegen/gles1 -E ../../../device/generic/goldfish-opengl/system/GLESv1_enc gl
...
./build/gfxstream-generic-apigen -i ./codegen/gles2 -E ../../../device/generic/goldfish-opengl/system/GLESv2_enc gl2
...
./build/gfxstream-generic-apigen -i ./codegen/renderControl -E ../../../device/generic/goldfish-opengl/system/renderControl_enc renderControl
