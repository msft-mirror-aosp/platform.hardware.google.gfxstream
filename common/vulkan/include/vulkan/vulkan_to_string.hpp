...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string( SwapchainImageUsageFlagsANDROID value )
  {
    if ( !value )
      return "{}";

    std::string result;
    if ( value & SwapchainImageUsageFlagBitsANDROID::eShared ) result += "Shared | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( VideoEncodeH264CapabilityFlagsEXT value )
  {
    ...
    if ( value & VideoEncodeH264CapabilityFlagBitsEXT::eDifferentReferenceFinalLists ) result += "DifferentReferenceFinalLists | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( VideoEncodeH265CapabilityFlagsEXT value )
  {
    ...
    if ( value & VideoEncodeH265CapabilityFlagBitsEXT::eDifferentReferenceFinalLists ) result += "DifferentReferenceFinalLists | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( StructureType value )
  {
    switch ( value )
    {
      ...
      case StructureType::eSwapchainImageCreateInfoANDROID : return "SwapchainImageCreateInfoANDROID";
      case StructureType::ePhysicalDevicePresentationPropertiesANDROID : return "PhysicalDevicePresentationPropertiesANDROID";
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
  ...
  VULKAN_HPP_INLINE std::string to_string( SwapchainImageUsageFlagBitsANDROID value )
  {
    switch ( value )
    {
      case SwapchainImageUsageFlagBitsANDROID::eShared : return "Shared";
      default: return "invalid ( " + VULKAN_HPP_NAMESPACE::toHexString( static_cast<uint32_t>( value ) ) + " )";
    }
