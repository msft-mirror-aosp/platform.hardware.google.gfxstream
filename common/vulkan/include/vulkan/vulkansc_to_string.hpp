...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string( MemoryHeapFlags value )
  {
    ...
    if ( value & MemoryHeapFlagBits::eSeuSafe ) result += "SeuSafe | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( PipelineCacheCreateFlags value )
  {
    ...
    if ( value & PipelineCacheCreateFlagBits::eReadOnly ) result += "ReadOnly | ";
    if ( value & PipelineCacheCreateFlagBits::eUseApplicationStorage ) result += "UseApplicationStorage | ";
...
#if defined( VK_USE_PLATFORM_SCI )
    if ( value & ExternalFenceHandleTypeFlagBits::eSciSyncObjNV ) result += "SciSyncObjNV | ";
    if ( value & ExternalFenceHandleTypeFlagBits::eSciSyncFenceNV ) result += "SciSyncFenceNV | ";
#endif /*VK_USE_PLATFORM_SCI*/
...
#if defined( VK_USE_PLATFORM_SCI )
    if ( value & ExternalSemaphoreHandleTypeFlagBits::eSciSyncObjNV ) result += "SciSyncObjNV | ";
#endif /*VK_USE_PLATFORM_SCI*/
