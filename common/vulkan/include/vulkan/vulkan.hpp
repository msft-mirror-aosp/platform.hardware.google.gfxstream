...
#  endif
  ...
  //=== VK_ANDROID_native_buffer ===
    ...
    VkResult vkGetSwapchainGrallocUsageANDROID( VkDevice device, VkFormat format, VkImageUsageFlags imageUsage, int * grallocUsage ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkGetSwapchainGrallocUsageANDROID( device, format, imageUsage, grallocUsage );
    }


    VkResult vkAcquireImageANDROID( VkDevice device, VkImage image, int nativeFenceFd, VkSemaphore semaphore, VkFence fence ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkAcquireImageANDROID( device, image, nativeFenceFd, semaphore, fence );
    }


    VkResult vkQueueSignalReleaseImageANDROID( VkQueue queue, uint32_t waitSemaphoreCount, const VkSemaphore * pWaitSemaphores, VkImage image, int * pNativeFenceFd ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkQueueSignalReleaseImageANDROID( queue, waitSemaphoreCount, pWaitSemaphores, image, pNativeFenceFd );
    }


    VkResult vkGetSwapchainGrallocUsage2ANDROID( VkDevice device, VkFormat format, VkImageUsageFlags imageUsage, VkSwapchainImageUsageFlagsANDROID swapchainImageUsage, uint64_t * grallocConsumerUsage, uint64_t * grallocProducerUsage ) const VULKAN_HPP_NOEXCEPT
    {
...
#  endif
  ...
  //=== VK_ANDROID_native_buffer ===
    ...
    PFN_vkGetSwapchainGrallocUsage2ANDROID vkGetSwapchainGrallocUsage2ANDROID = 0;
#else
    PFN_dummy vkGetSwapchainGrallocUsageANDROID_placeholder = 0;
    PFN_dummy vkAcquireImageANDROID_placeholder = 0;
    PFN_dummy vkQueueSignalReleaseImageANDROID_placeholder = 0;
    PFN_dummy vkGetSwapchainGrallocUsage2ANDROID_placeholder = 0;
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
...
#if defined( VK_USE_PLATFORM_ANDROID_KHR )
  //=== VK_ANDROID_native_buffer ===
      vkGetSwapchainGrallocUsageANDROID = PFN_vkGetSwapchainGrallocUsageANDROID( vkGetInstanceProcAddr( instance, "vkGetSwapchainGrallocUsageANDROID" ) );
      vkAcquireImageANDROID = PFN_vkAcquireImageANDROID( vkGetInstanceProcAddr( instance, "vkAcquireImageANDROID" ) );
      vkQueueSignalReleaseImageANDROID = PFN_vkQueueSignalReleaseImageANDROID( vkGetInstanceProcAddr( instance, "vkQueueSignalReleaseImageANDROID" ) );
      vkGetSwapchainGrallocUsage2ANDROID = PFN_vkGetSwapchainGrallocUsage2ANDROID( vkGetInstanceProcAddr( instance, "vkGetSwapchainGrallocUsage2ANDROID" ) );
#endif /*VK_USE_PLATFORM_ANDROID_KHR*/
