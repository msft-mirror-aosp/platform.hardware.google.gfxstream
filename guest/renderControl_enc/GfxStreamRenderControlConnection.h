...
#ifndef GFXSTREAM_RENDER_CONTROL_CONNECTION_H
#define GFXSTREAM_RENDER_CONTROL_CONNECTION_H
...
class GfxStreamRenderControlConnection : public GfxStreamConnection {
   public:
    ...
    gfxstream::guest::ChecksumCalculator* getCheckSumHelper();

   private:
    std::unique_ptr<ExtendedRCEncoderContext> mRcEnc;
    gfxstream::guest::ChecksumCalculator mCheckSumHelper;
};
