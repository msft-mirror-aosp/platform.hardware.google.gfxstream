...
int magma_server_context_t::initDispatchByName(void *(*getProc)(const char *, void *userData), void *userData)
{
	...
	magma_connection_export_buffer = (magma_connection_export_buffer_server_proc_t) getProc("magma_connection_export_buffer", userData);
	...
	magma_connection_export_semaphore = (magma_connection_export_semaphore_server_proc_t) getProc("magma_connection_export_semaphore", userData);
	...
	magma_connection_buffer_range_op = (magma_connection_buffer_range_op_server_proc_t) getProc("magma_connection_buffer_range_op", userData);
	...
	magma_buffer_get_id = (magma_buffer_get_id_server_proc_t) getProc("magma_buffer_get_id", userData);
	magma_buffer_get_size = (magma_buffer_get_size_server_proc_t) getProc("magma_buffer_get_size", userData);
	...
	magma_semaphore_get_id = (magma_semaphore_get_id_server_proc_t) getProc("magma_semaphore_get_id", userData);
