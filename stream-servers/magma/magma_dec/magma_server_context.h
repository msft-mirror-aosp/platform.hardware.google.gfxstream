...
struct magma_server_context_t {
	...
	magma_connection_export_buffer_server_proc_t magma_connection_export_buffer;
	...
	magma_connection_export_semaphore_server_proc_t magma_connection_export_semaphore;
	magma_connection_import_semaphore_server_proc_t magma_connection_import_semaphore;
	magma_connection_buffer_range_op_server_proc_t magma_connection_buffer_range_op;
	...
	magma_buffer_get_id_server_proc_t magma_buffer_get_id;
	magma_buffer_get_size_server_proc_t magma_buffer_get_size;
	...
	magma_semaphore_get_id_server_proc_t magma_semaphore_get_id;
