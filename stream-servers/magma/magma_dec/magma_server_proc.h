...
typedef magma_status_t (magma_APIENTRY *magma_connection_create_buffer_server_proc_t) (magma_connection_t, uint64_t, uint64_t*, magma_buffer_t*);
typedef void (magma_APIENTRY *magma_connection_release_buffer_server_proc_t) (magma_connection_t, magma_buffer_t);
typedef magma_status_t (magma_APIENTRY *magma_connection_export_buffer_server_proc_t) (magma_connection_t, magma_buffer_t, magma_handle_t*);
typedef magma_status_t (magma_APIENTRY *magma_connection_import_buffer_server_proc_t) (magma_connection_t, magma_handle_t, magma_buffer_t*);
typedef magma_status_t (magma_APIENTRY *magma_connection_create_semaphore_server_proc_t) (magma_connection_t, magma_semaphore_t*);
typedef void (magma_APIENTRY *magma_connection_release_semaphore_server_proc_t) (magma_connection_t, magma_semaphore_t);
typedef magma_status_t (magma_APIENTRY *magma_connection_export_semaphore_server_proc_t) (magma_connection_t, magma_semaphore_t, magma_handle_t*);
typedef magma_status_t (magma_APIENTRY *magma_connection_import_semaphore_server_proc_t) (magma_connection_t, magma_handle_t, magma_semaphore_t*);
typedef magma_status_t (magma_APIENTRY *magma_connection_buffer_range_op_server_proc_t) (magma_connection_t, magma_buffer_t, uint32_t, uint64_t, uint64_t);
...
typedef uint64_t (magma_APIENTRY *magma_buffer_get_id_server_proc_t) (magma_buffer_t);
typedef uint64_t (magma_APIENTRY *magma_buffer_get_size_server_proc_t) (magma_buffer_t);
...
typedef uint64_t (magma_APIENTRY *magma_semaphore_get_id_server_proc_t) (magma_semaphore_t);
