  ...
  *ptr += sizeof(uint32_t);
  {
    ...
    *ptr += sizeof(uint32_t);
    for (uint32_t i = 0; i < c; ++i) {
      uint32_t l =
          forMarshaling->ppEnabledLayerNames ? strlen(forMarshaling->ppEnabledLayerNames[i]) : 0;
      memcpy(*ptr, (uint32_t*)&l, sizeof(uint32_t));
      android::base::Stream::toBe32((uint8_t*)*ptr);
      *ptr += sizeof(uint32_t);
      if (l) {
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->queueCreateInfoCount; ++i) {
    reservedmarshal_VkDeviceQueueCreateInfo(
        vkStream, rootType, (const VkDeviceQueueCreateInfo*)(forMarshaling->pQueueCreateInfos + i),
        ptr);
  }
  memcpy(*ptr, (uint32_t*)&forMarshaling->enabledLayerCount, sizeof(uint32_t));
  *ptr += sizeof(uint32_t);
...
void reservedmarshal_VkSparseBufferMemoryBindInfo(VulkanStreamGuest* vkStream,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->bindCount; ++i) {
    reservedmarshal_VkSparseMemoryBind(vkStream, rootType,
                                       (const VkSparseMemoryBind*)(forMarshaling->pBinds + i), ptr);
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->bufferBindCount; ++i) {
    reservedmarshal_VkSparseBufferMemoryBindInfo(
        vkStream, rootType, (const VkSparseBufferMemoryBindInfo*)(forMarshaling->pBufferBinds + i),
        ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->imageBindCount; ++i) {
    reservedmarshal_VkSparseImageMemoryBindInfo(
        vkStream, rootType, (const VkSparseImageMemoryBindInfo*)(forMarshaling->pImageBinds + i),
        ptr);
  }
  memcpy(*ptr, (uint32_t*)&forMarshaling->signalSemaphoreCount, sizeof(uint32_t));
  *ptr += sizeof(uint32_t);
...
void reservedmarshal_VkSparseImageMemoryRequirements(
  ...
  reservedmarshal_VkSparseImageFormatProperties(
      vkStream, rootType, (VkSparseImageFormatProperties*)(&forMarshaling->formatProperties), ptr);
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->mapEntryCount; ++i) {
    reservedmarshal_VkSpecializationMapEntry(
        vkStream, rootType, (const VkSpecializationMapEntry*)(forMarshaling->pMapEntries + i), ptr);
  }
  ...
  *ptr += 8;
  if (forMarshaling->pSpecializationInfo) {
    reservedmarshal_VkSpecializationInfo(
        vkStream, rootType, (const VkSpecializationInfo*)(forMarshaling->pSpecializationInfo), ptr);
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->vertexAttributeDescriptionCount; ++i) {
    reservedmarshal_VkVertexInputAttributeDescription(
        vkStream, rootType,
        (const VkVertexInputAttributeDescription*)(forMarshaling->pVertexAttributeDescriptions + i),
        ptr);
  }
}
  ...
  *ptr += 8;
  if (forMarshaling->pScissors) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->scissorCount; ++i) {
      reservedmarshal_VkRect2D(vkStream, rootType, (const VkRect2D*)(forMarshaling->pScissors + i),
                               ptr);
    }
  }
}
...
void reservedmarshal_VkGraphicsPipelineCreateInfo(VulkanStreamGuest* vkStream,
  ...
  if (vkStream->getFeatureBits() & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) {
    hasTessellation = arrayany(forMarshaling->pStages, 0, forMarshaling->stageCount,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->stageCount; ++i) {
    reservedmarshal_VkPipelineShaderStageCreateInfo(
        vkStream, rootType, (const VkPipelineShaderStageCreateInfo*)(forMarshaling->pStages + i),
        ptr);
  }
  // WARNING PTR CHECK
  if (vkStream->getFeatureBits() & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) {
  ...
  if ((!(vkStream->getFeatureBits() & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) ||
    ...
    reservedmarshal_VkPipelineInputAssemblyStateCreateInfo(
        vkStream, rootType,
        (const VkPipelineInputAssemblyStateCreateInfo*)(forMarshaling->pInputAssemblyState), ptr);
  }
  // WARNING PTR CHECK
  ...
  *ptr += 8;
  ...
  if ((!(vkStream->getFeatureBits() & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) ||
    ...
    reservedmarshal_VkPipelineRasterizationStateCreateInfo(
        vkStream, rootType,
        (const VkPipelineRasterizationStateCreateInfo*)(forMarshaling->pRasterizationState), ptr);
  }
  // WARNING PTR CHECK
  ...
  if (forMarshaling->pMultisampleState) {
    if (hasRasterization) {
      reservedmarshal_VkPipelineMultisampleStateCreateInfo(
          vkStream, rootType,
          (const VkPipelineMultisampleStateCreateInfo*)(forMarshaling->pMultisampleState), ptr);
    }
  }
  // WARNING PTR CHECK
  ...
  if (forMarshaling->pDepthStencilState) {
    if (hasRasterization) {
      reservedmarshal_VkPipelineDepthStencilStateCreateInfo(
          vkStream, rootType,
          (const VkPipelineDepthStencilStateCreateInfo*)(forMarshaling->pDepthStencilState), ptr);
    }
  }
  // WARNING PTR CHECK
  ...
  *ptr += 8;
  if (forMarshaling->pDynamicState) {
    reservedmarshal_VkPipelineDynamicStateCreateInfo(
        vkStream, rootType, (const VkPipelineDynamicStateCreateInfo*)(forMarshaling->pDynamicState),
        ptr);
  }
  uint64_t cgen_var_6;
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->pushConstantRangeCount; ++i) {
    reservedmarshal_VkPushConstantRange(
        vkStream, rootType, (const VkPushConstantRange*)(forMarshaling->pPushConstantRanges + i),
        ptr);
  }
}
    ...
    if ((!(vkStream->getFeatureBits() & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) ||
      ...
      for (uint32_t i = 0; i < (uint32_t)forMarshaling->descriptorCount; ++i) {
        reservedmarshal_VkDescriptorImageInfo(
            vkStream, rootType, (const VkDescriptorImageInfo*)(forMarshaling->pImageInfo + i), ptr);
      }
    }
  }
  // WARNING PTR CHECK
    ...
    if ((!(vkStream->getFeatureBits() & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) ||
      ...
      for (uint32_t i = 0; i < (uint32_t)forMarshaling->descriptorCount; ++i) {
        reservedmarshal_VkDescriptorBufferInfo(
            vkStream, rootType, (const VkDescriptorBufferInfo*)(forMarshaling->pBufferInfo + i),
            ptr);
      }
    }
  }
...
void reservedmarshal_VkSubpassDescription(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->inputAttachmentCount; ++i) {
    reservedmarshal_VkAttachmentReference(
        vkStream, rootType, (const VkAttachmentReference*)(forMarshaling->pInputAttachments + i),
        ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->colorAttachmentCount; ++i) {
    reservedmarshal_VkAttachmentReference(
        vkStream, rootType, (const VkAttachmentReference*)(forMarshaling->pColorAttachments + i),
        ptr);
  }
  // WARNING PTR CHECK
  ...
  *ptr += 8;
  if (forMarshaling->pDepthStencilAttachment) {
    reservedmarshal_VkAttachmentReference(
        vkStream, rootType, (const VkAttachmentReference*)(forMarshaling->pDepthStencilAttachment),
        ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->attachmentCount; ++i) {
    reservedmarshal_VkAttachmentDescription(
        vkStream, rootType, (const VkAttachmentDescription*)(forMarshaling->pAttachments + i), ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->dependencyCount; ++i) {
    reservedmarshal_VkSubpassDependency(
        vkStream, rootType, (const VkSubpassDependency*)(forMarshaling->pDependencies + i), ptr);
  }
}
...
void reservedmarshal_VkClearValue(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  (void)vkStream;
  (void)rootType;
  reservedmarshal_VkClearColorValue(vkStream, rootType, (VkClearColorValue*)(&forMarshaling->color),
                                    ptr);
}
  ...
  *ptr += 8;
  if (forMarshaling->pClearValues) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->clearValueCount; ++i) {
      reservedmarshal_VkClearValue(vkStream, rootType,
                                   (const VkClearValue*)(forMarshaling->pClearValues + i), ptr);
    }
  }
}
...
void reservedmarshal_VkBindImageMemoryDeviceGroupInfo(
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->splitInstanceBindRegionCount; ++i) {
    reservedmarshal_VkRect2D(vkStream, rootType,
                             (const VkRect2D*)(forMarshaling->pSplitInstanceBindRegions + i), ptr);
  }
}
...
void reservedmarshal_VkFormatProperties2(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += sizeof(VkStructureType);
  ...
  reservedmarshal_extension_struct(vkStream, rootType, forMarshaling->pNext, ptr);
  reservedmarshal_VkFormatProperties(vkStream, rootType,
                                     (VkFormatProperties*)(&forMarshaling->formatProperties), ptr);
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->descriptorUpdateEntryCount; ++i) {
    reservedmarshal_VkDescriptorUpdateTemplateEntry(
        vkStream, rootType,
        (const VkDescriptorUpdateTemplateEntry*)(forMarshaling->pDescriptorUpdateEntries + i), ptr);
  }
...
void reservedmarshal_VkSubpassDescription2(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->inputAttachmentCount; ++i) {
    reservedmarshal_VkAttachmentReference2(
        vkStream, rootType, (const VkAttachmentReference2*)(forMarshaling->pInputAttachments + i),
        ptr);
  }
  memcpy(*ptr, (uint32_t*)&forMarshaling->colorAttachmentCount, sizeof(uint32_t));
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->colorAttachmentCount; ++i) {
    reservedmarshal_VkAttachmentReference2(
        vkStream, rootType, (const VkAttachmentReference2*)(forMarshaling->pColorAttachments + i),
        ptr);
  }
  // WARNING PTR CHECK
  uint64_t cgen_var_0 = (uint64_t)(uintptr_t)forMarshaling->pResolveAttachments;
  ...
  *ptr += 8;
  if (forMarshaling->pDepthStencilAttachment) {
    reservedmarshal_VkAttachmentReference2(
        vkStream, rootType, (const VkAttachmentReference2*)(forMarshaling->pDepthStencilAttachment),
        ptr);
  }
  memcpy(*ptr, (uint32_t*)&forMarshaling->preserveAttachmentCount, sizeof(uint32_t));
  *ptr += sizeof(uint32_t);
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->dependencyCount; ++i) {
    reservedmarshal_VkSubpassDependency2(
        vkStream, rootType, (const VkSubpassDependency2*)(forMarshaling->pDependencies + i), ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->attachmentImageInfoCount; ++i) {
    reservedmarshal_VkFramebufferAttachmentImageInfo(
        vkStream, rootType,
        (const VkFramebufferAttachmentImageInfo*)(forMarshaling->pAttachmentImageInfos + i), ptr);
  }
}
...
void reservedmarshal_VkDisplayPropertiesKHR(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += 1 * 8;
  ...
  reservedmarshal_VkExtent2D(vkStream, rootType, (VkExtent2D*)(&forMarshaling->physicalDimensions),
                             ptr);
  reservedmarshal_VkExtent2D(vkStream, rootType, (VkExtent2D*)(&forMarshaling->physicalResolution),
                             ptr);
  memcpy(*ptr, (VkSurfaceTransformFlagsKHR*)&forMarshaling->supportedTransforms,
         sizeof(VkSurfaceTransformFlagsKHR));
  *ptr += sizeof(VkSurfaceTransformFlagsKHR);
...
void reservedmarshal_VkVideoReferenceSlotKHR(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += sizeof(int8_t);
  reservedmarshal_VkVideoPictureResourceKHR(
      vkStream, rootType, (const VkVideoPictureResourceKHR*)(forMarshaling->pPictureResource), ptr);
}
...
void reservedmarshal_VkVideoSessionCreateInfoKHR(VulkanStreamGuest* vkStream,
  ...
  *ptr += sizeof(VkVideoSessionCreateFlagsKHR);
  reservedmarshal_VkVideoProfileKHR(vkStream, rootType,
                                    (const VkVideoProfileKHR*)(forMarshaling->pVideoProfile), ptr);
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->referenceSlotCount; ++i) {
    reservedmarshal_VkVideoReferenceSlotKHR(
        vkStream, rootType, (const VkVideoReferenceSlotKHR*)(forMarshaling->pReferenceSlots + i),
        ptr);
  }
}
...
void reservedmarshal_VkRenderingInfoKHR(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += 8;
  if (forMarshaling->pDepthAttachment) {
    reservedmarshal_VkRenderingAttachmentInfoKHR(
        vkStream, rootType, (const VkRenderingAttachmentInfoKHR*)(forMarshaling->pDepthAttachment),
        ptr);
  }
  // WARNING PTR CHECK
  ...
  *ptr += 8;
  if (forMarshaling->pRectangles) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->rectangleCount; ++i) {
      reservedmarshal_VkRectLayerKHR(vkStream, rootType,
                                     (const VkRectLayerKHR*)(forMarshaling->pRectangles + i), ptr);
    }
  }
}
...
void reservedmarshal_VkPhysicalDeviceFragmentShadingRatePropertiesKHR(
  ...
  *ptr += sizeof(VkStructureType);
  ...
  reservedmarshal_VkExtent2D(
      vkStream, rootType, (VkExtent2D*)(&forMarshaling->minFragmentShadingRateAttachmentTexelSize),
      ptr);
  reservedmarshal_VkExtent2D(
      vkStream, rootType, (VkExtent2D*)(&forMarshaling->maxFragmentShadingRateAttachmentTexelSize),
      ptr);
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->memoryBarrierCount; ++i) {
    reservedmarshal_VkMemoryBarrier2KHR(
        vkStream, rootType, (const VkMemoryBarrier2KHR*)(forMarshaling->pMemoryBarriers + i), ptr);
  }
...
void reservedmarshal_VkCopyBufferInfo2KHR(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->regionCount; ++i) {
    reservedmarshal_VkBufferCopy2KHR(vkStream, rootType,
                                     (const VkBufferCopy2KHR*)(forMarshaling->pRegions + i), ptr);
  }
}
...
void reservedmarshal_VkDeviceBufferMemoryRequirementsKHR(
  ...
  *ptr += sizeof(VkStructureType);
  ...
  reservedmarshal_VkBufferCreateInfo(vkStream, rootType,
                                     (const VkBufferCreateInfo*)(forMarshaling->pCreateInfo), ptr);
}
...
void reservedmarshal_VkVideoEncodeH264CapabilitiesEXT(
  ...
  *ptr += sizeof(VkVideoEncodeH264OutputModeFlagsEXT);
  reservedmarshal_VkExtent2D(vkStream, rootType, (VkExtent2D*)(&forMarshaling->minPictureSizeInMbs),
                             ptr);
  reservedmarshal_VkExtent2D(vkStream, rootType, (VkExtent2D*)(&forMarshaling->maxPictureSizeInMbs),
                             ptr);
  reservedmarshal_VkExtent2D(vkStream, rootType,
...
void reservedmarshal_VkVideoEncodeH264SessionCreateInfoEXT(
  ...
  *ptr += sizeof(VkVideoEncodeH264CreateFlagsEXT);
  reservedmarshal_VkExtent2D(vkStream, rootType, (VkExtent2D*)(&forMarshaling->maxPictureSizeInMbs),
                             ptr);
  reservedmarshal_VkExtensionProperties(
      vkStream, rootType, (const VkExtensionProperties*)(forMarshaling->pStdExtensionVersion), ptr);
}
  ...
  *ptr += 8;
  if (forMarshaling->pParametersAddInfo) {
    reservedmarshal_VkVideoEncodeH264SessionParametersAddInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH264SessionParametersAddInfoEXT*)(forMarshaling->pParametersAddInfo),
        ptr);
  }
}
...
void reservedmarshal_VkVideoEncodeH264NaluSliceEXT(
  ...
  *ptr += sizeof(uint8_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->refFinalList0EntryCount; ++i) {
    reservedmarshal_VkVideoEncodeH264DpbSlotInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH264DpbSlotInfoEXT*)(forMarshaling->pRefFinalList0Entries + i), ptr);
  }
  ...
  *ptr += sizeof(uint8_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->refFinalList1EntryCount; ++i) {
    reservedmarshal_VkVideoEncodeH264DpbSlotInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH264DpbSlotInfoEXT*)(forMarshaling->pRefFinalList1Entries + i), ptr);
  }
...
void reservedmarshal_VkVideoEncodeH264VclFrameInfoEXT(
  ...
  *ptr += sizeof(uint8_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->refDefaultFinalList0EntryCount; ++i) {
    reservedmarshal_VkVideoEncodeH264DpbSlotInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH264DpbSlotInfoEXT*)(forMarshaling->pRefDefaultFinalList0Entries + i),
        ptr);
  }
  ...
  *ptr += sizeof(uint8_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->refDefaultFinalList1EntryCount; ++i) {
    reservedmarshal_VkVideoEncodeH264DpbSlotInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH264DpbSlotInfoEXT*)(forMarshaling->pRefDefaultFinalList1Entries + i),
        ptr);
  }
  ...
  *ptr += 8;
  if (forMarshaling->pParametersAddInfo) {
    reservedmarshal_VkVideoEncodeH265SessionParametersAddInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH265SessionParametersAddInfoEXT*)(forMarshaling->pParametersAddInfo),
        ptr);
  }
}
...
void reservedmarshal_VkVideoEncodeH265ReferenceListsEXT(
  ...
  *ptr += sizeof(uint8_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->referenceList0EntryCount; ++i) {
    reservedmarshal_VkVideoEncodeH265DpbSlotInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH265DpbSlotInfoEXT*)(forMarshaling->pReferenceList0Entries + i), ptr);
  }
  ...
  *ptr += sizeof(uint8_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->referenceList1EntryCount; ++i) {
    reservedmarshal_VkVideoEncodeH265DpbSlotInfoEXT(
        vkStream, rootType,
        (const VkVideoEncodeH265DpbSlotInfoEXT*)(forMarshaling->pReferenceList1Entries + i), ptr);
  }
  memcpy(*ptr,
  ...
  *ptr += 8;
  if (forMarshaling->pParametersAddInfo) {
    reservedmarshal_VkVideoDecodeH264SessionParametersAddInfoEXT(
        vkStream, rootType,
        (const VkVideoDecodeH264SessionParametersAddInfoEXT*)(forMarshaling->pParametersAddInfo),
        ptr);
  }
}
  ...
  if (forMarshaling->pViewportWScalings) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->viewportCount; ++i) {
      reservedmarshal_VkViewportWScalingNV(
          vkStream, rootType, (const VkViewportWScalingNV*)(forMarshaling->pViewportWScalings + i),
          ptr);
    }
  }
}
  ...
  if (forMarshaling->pViewportSwizzles) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->viewportCount; ++i) {
      reservedmarshal_VkViewportSwizzleNV(
          vkStream, rootType, (const VkViewportSwizzleNV*)(forMarshaling->pViewportSwizzles + i),
          ptr);
    }
  }
}
  ...
  if (forMarshaling->pObjects) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->objectCount; ++i) {
      reservedmarshal_VkDebugUtilsObjectNameInfoEXT(
          vkStream, rootType, (VkDebugUtilsObjectNameInfoEXT*)(forMarshaling->pObjects + i), ptr);
    }
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->sampleLocationsCount; ++i) {
    reservedmarshal_VkSampleLocationEXT(
        vkStream, rootType, (const VkSampleLocationEXT*)(forMarshaling->pSampleLocations + i), ptr);
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->attachmentInitialSampleLocationsCount; ++i) {
    reservedmarshal_VkAttachmentSampleLocationsEXT(
        vkStream, rootType,
        (const VkAttachmentSampleLocationsEXT*)(forMarshaling->pAttachmentInitialSampleLocations +
                                                i),
        ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->postSubpassSampleLocationsCount; ++i) {
    reservedmarshal_VkSubpassSampleLocationsEXT(
        vkStream, rootType,
        (const VkSubpassSampleLocationsEXT*)(forMarshaling->pPostSubpassSampleLocations + i), ptr);
  }
}
  ...
  if (forMarshaling->pDrmFormatModifierProperties) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->drmFormatModifierCount; ++i) {
      reservedmarshal_VkDrmFormatModifierPropertiesEXT(
          vkStream, rootType,
          (VkDrmFormatModifierPropertiesEXT*)(forMarshaling->pDrmFormatModifierProperties + i),
          ptr);
    }
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->drmFormatModifierPlaneCount; ++i) {
    reservedmarshal_VkSubresourceLayout(
        vkStream, rootType, (const VkSubresourceLayout*)(forMarshaling->pPlaneLayouts + i), ptr);
  }
}
  ...
  if (forMarshaling->pDrmFormatModifierProperties) {
    for (uint32_t i = 0; i < (uint32_t)forMarshaling->drmFormatModifierCount; ++i) {
      reservedmarshal_VkDrmFormatModifierProperties2EXT(
          vkStream, rootType,
          (VkDrmFormatModifierProperties2EXT*)(forMarshaling->pDrmFormatModifierProperties + i),
          ptr);
    }
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->sampleLocationCount; ++i) {
    reservedmarshal_VkCoarseSampleLocationNV(
        vkStream, rootType, (const VkCoarseSampleLocationNV*)(forMarshaling->pSampleLocations + i),
        ptr);
  }
}
    ...
    if (forMarshaling->accelerationStructureCount) {
      ...
      if (forMarshaling) {
        for (uint32_t k = 0; k < forMarshaling->accelerationStructureCount; ++k) {
          uint64_t tmpval =
              get_host_u64_VkAccelerationStructureNV(forMarshaling->pAccelerationStructures[k]);
          memcpy(cgen_var_0_0_ptr + k * 8, &tmpval, sizeof(uint64_t));
        }
      }
...
void reservedmarshal_VkAccelerationStructureInstanceKHR(
  ...
  reservedmarshal_VkTransformMatrixKHR(vkStream, rootType,
                                       (VkTransformMatrixKHR*)(&forMarshaling_new->transform), ptr);
  ...
  *ptr += 8;
  if (forMarshaling->pParametersAddInfo) {
    reservedmarshal_VkVideoDecodeH265SessionParametersAddInfoEXT(
        vkStream, rootType,
        (const VkVideoDecodeH265SessionParametersAddInfoEXT*)(forMarshaling->pParametersAddInfo),
        ptr);
  }
}
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->vertexBindingDivisorCount; ++i) {
    reservedmarshal_VkVertexInputBindingDivisorDescriptionEXT(
        vkStream, rootType,
        (const VkVertexInputBindingDivisorDescriptionEXT*)(forMarshaling->pVertexBindingDivisors +
                                                           i),
        ptr);
  }
}
...
void reservedmarshal_VkPipelineCreationFeedbackCreateInfoEXT(
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->pipelineStageCreationFeedbackCount; ++i) {
    reservedmarshal_VkPipelineCreationFeedbackEXT(
        vkStream, rootType,
        (VkPipelineCreationFeedbackEXT*)(forMarshaling->pPipelineStageCreationFeedbacks + i), ptr);
  }
}
...
void reservedmarshal_VkValidationFeaturesEXT(VulkanStreamGuest* vkStream, VkStructureType rootType,
  ...
  *ptr += sizeof(uint32_t);
  memcpy(*ptr, (const VkValidationFeatureEnableEXT*)forMarshaling->pEnabledValidationFeatures,
  ...
  *ptr += sizeof(uint32_t);
  memcpy(
      *ptr, (const VkValidationFeatureDisableEXT*)forMarshaling->pDisabledValidationFeatures,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->groupCount; ++i) {
    reservedmarshal_VkGraphicsShaderGroupCreateInfoNV(
        vkStream, rootType, (const VkGraphicsShaderGroupCreateInfoNV*)(forMarshaling->pGroups + i),
        ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->tokenCount; ++i) {
    reservedmarshal_VkIndirectCommandsLayoutTokenNV(
        vkStream, rootType, (const VkIndirectCommandsLayoutTokenNV*)(forMarshaling->pTokens + i),
        ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->streamCount; ++i) {
    reservedmarshal_VkIndirectCommandsStreamNV(
        vkStream, rootType, (const VkIndirectCommandsStreamNV*)(forMarshaling->pStreams + i), ptr);
  }
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->mutableDescriptorTypeListCount; ++i) {
    reservedmarshal_VkMutableDescriptorTypeListVALVE(
        vkStream, rootType,
        (const VkMutableDescriptorTypeListVALVE*)(forMarshaling->pMutableDescriptorTypeLists + i),
        ptr);
  }
}
...
void reservedmarshal_VkBufferCollectionPropertiesFUCHSIA(
  ...
  *ptr += sizeof(VkFormatFeatureFlags);
  reservedmarshal_VkSysmemColorSpaceFUCHSIA(
      vkStream, rootType, (VkSysmemColorSpaceFUCHSIA*)(&forMarshaling->sysmemColorSpaceIndex), ptr);
  reservedmarshal_VkComponentMapping(
      vkStream, rootType, (VkComponentMapping*)(&forMarshaling->samplerYcbcrConversionComponents),
      ptr);
  memcpy(*ptr, (VkSamplerYcbcrModelConversion*)&forMarshaling->suggestedYcbcrModel,
  ...
  *ptr += sizeof(uint32_t);
  for (uint32_t i = 0; i < (uint32_t)forMarshaling->formatConstraintsCount; ++i) {
    reservedmarshal_VkImageFormatConstraintsInfoFUCHSIA(
        vkStream, rootType,
        (const VkImageFormatConstraintsInfoFUCHSIA*)(forMarshaling->pFormatConstraints + i), ptr);
  }
  reservedmarshal_VkBufferCollectionConstraintsInfoFUCHSIA(
      vkStream, rootType,
      (VkBufferCollectionConstraintsInfoFUCHSIA*)(&forMarshaling->bufferCollectionConstraints),
...
void reservedmarshal_VkAccelerationStructureGeometryKHR(
  ...
  *ptr += sizeof(VkGeometryTypeKHR);
  reservedmarshal_VkAccelerationStructureGeometryDataKHR(
      vkStream, rootType, (VkAccelerationStructureGeometryDataKHR*)(&forMarshaling->geometry), ptr);
  memcpy(*ptr, (VkGeometryFlagsKHR*)&forMarshaling->flags, sizeof(VkGeometryFlagsKHR));
  *ptr += sizeof(VkGeometryFlagsKHR);
}
  ...
  if (forMarshaling->pAccelerationStructures) {
    if (forMarshaling->accelerationStructureCount) {
      ...
      if (forMarshaling) {
        for (uint32_t k = 0; k < forMarshaling->accelerationStructureCount; ++k) {
          uint64_t tmpval =
              get_host_u64_VkAccelerationStructureKHR(forMarshaling->pAccelerationStructures[k]);
          memcpy(cgen_var_0_0_ptr + k * 8, &tmpval, sizeof(uint64_t));
        }
      }
      *ptr += 8 * forMarshaling->accelerationStructureCount;
  ...
  *ptr += 8;
  if (forMarshaling->pLibraryInfo) {
    reservedmarshal_VkPipelineLibraryCreateInfoKHR(
        vkStream, rootType, (const VkPipelineLibraryCreateInfoKHR*)(forMarshaling->pLibraryInfo),
        ptr);
  }
  // WARNING PTR CHECK
  ...
  *ptr += 8;
  if (forMarshaling->pLibraryInterface) {
    reservedmarshal_VkRayTracingPipelineInterfaceCreateInfoKHR(
        vkStream, rootType,
        (const VkRayTracingPipelineInterfaceCreateInfoKHR*)(forMarshaling->pLibraryInterface), ptr);
  }
  // WARNING PTR CHECK
  ...
  switch (structType) {
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES: {
      reservedmarshal_VkPhysicalDevice16BitStorageFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevice16BitStorageFeatures*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO: {
      reservedmarshal_VkMemoryAllocateFlagsInfo(
          vkStream, rootType, reinterpret_cast<const VkMemoryAllocateFlagsInfo*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO: {
      reservedmarshal_VkDeviceGroupSubmitInfo(
          vkStream, rootType, reinterpret_cast<const VkDeviceGroupSubmitInfo*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO: {
      reservedmarshal_VkDeviceGroupBindSparseInfo(
          vkStream, rootType, reinterpret_cast<const VkDeviceGroupBindSparseInfo*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2: {
      reservedmarshal_VkPhysicalDeviceFeatures2(
          vkStream, rootType, reinterpret_cast<const VkPhysicalDeviceFeatures2*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES: {
      reservedmarshal_VkPhysicalDevicePointClippingProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePointClippingProperties*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO: {
      reservedmarshal_VkRenderPassInputAttachmentAspectCreateInfo(
          vkStream, rootType,
          reinterpret_cast<const VkRenderPassInputAttachmentAspectCreateInfo*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO: {
      reservedmarshal_VkImageViewUsageCreateInfo(
          vkStream, rootType, reinterpret_cast<const VkImageViewUsageCreateInfo*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES: {
      reservedmarshal_VkPhysicalDeviceVariablePointersFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceVariablePointersFeatures*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES: {
      reservedmarshal_VkPhysicalDeviceProtectedMemoryFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceProtectedMemoryFeatures*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceProtectedMemoryProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceProtectedMemoryProperties*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PROTECTED_SUBMIT_INFO: {
      reservedmarshal_VkProtectedSubmitInfo(
          vkStream, rootType, reinterpret_cast<const VkProtectedSubmitInfo*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO: {
      reservedmarshal_VkBindImagePlaneMemoryInfo(
          vkStream, rootType, reinterpret_cast<const VkBindImagePlaneMemoryInfo*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES: {
      reservedmarshal_VkPhysicalDeviceSamplerYcbcrConversionFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSamplerYcbcrConversionFeatures*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES: {
      reservedmarshal_VkSamplerYcbcrConversionImageFormatProperties(
          vkStream, rootType,
          reinterpret_cast<const VkSamplerYcbcrConversionImageFormatProperties*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO: {
      reservedmarshal_VkPhysicalDeviceExternalImageFormatInfo(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceExternalImageFormatInfo*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO: {
      reservedmarshal_VkExportMemoryAllocateInfo(
          vkStream, rootType, reinterpret_cast<const VkExportMemoryAllocateInfo*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO: {
      reservedmarshal_VkExportFenceCreateInfo(
          vkStream, rootType, reinterpret_cast<const VkExportFenceCreateInfo*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO: {
      reservedmarshal_VkExportSemaphoreCreateInfo(
          vkStream, rootType, reinterpret_cast<const VkExportSemaphoreCreateInfo*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceMaintenance3Properties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMaintenance3Properties*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETERS_FEATURES: {
      reservedmarshal_VkPhysicalDeviceShaderDrawParametersFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderDrawParametersFeatures*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO: {
      reservedmarshal_VkImageFormatListCreateInfo(
          vkStream, rootType, reinterpret_cast<const VkImageFormatListCreateInfo*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES: {
      reservedmarshal_VkPhysicalDeviceShaderAtomicInt64Features(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderAtomicInt64Features*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES: {
      reservedmarshal_VkPhysicalDeviceShaderFloat16Int8Features(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderFloat16Int8Features*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceFloatControlsProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceFloatControlsProperties*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO: {
      reservedmarshal_VkDescriptorSetLayoutBindingFlagsCreateInfo(
          vkStream, rootType,
          reinterpret_cast<const VkDescriptorSetLayoutBindingFlagsCreateInfo*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES: {
      reservedmarshal_VkPhysicalDeviceDescriptorIndexingFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDescriptorIndexingFeatures*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceDescriptorIndexingProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDescriptorIndexingProperties*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE: {
      reservedmarshal_VkSubpassDescriptionDepthStencilResolve(
          vkStream, rootType,
          reinterpret_cast<const VkSubpassDescriptionDepthStencilResolve*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceDepthStencilResolveProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDepthStencilResolveProperties*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES: {
      reservedmarshal_VkPhysicalDeviceScalarBlockLayoutFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceScalarBlockLayoutFeatures*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceSamplerFilterMinmaxProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSamplerFilterMinmaxProperties*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES: {
      reservedmarshal_VkPhysicalDeviceVulkanMemoryModelFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceVulkanMemoryModelFeatures*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES: {
      reservedmarshal_VkPhysicalDeviceImagelessFramebufferFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceImagelessFramebufferFeatures*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT: {
      reservedmarshal_VkAttachmentDescriptionStencilLayout(
          vkStream, rootType,
          reinterpret_cast<const VkAttachmentDescriptionStencilLayout*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES: {
      reservedmarshal_VkPhysicalDeviceHostQueryResetFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceHostQueryResetFeatures*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES: {
      reservedmarshal_VkPhysicalDeviceTimelineSemaphoreFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceTimelineSemaphoreFeatures*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES: {
      reservedmarshal_VkPhysicalDeviceTimelineSemaphoreProperties(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceTimelineSemaphoreProperties*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO: {
      reservedmarshal_VkSemaphoreTypeCreateInfo(
          vkStream, rootType, reinterpret_cast<const VkSemaphoreTypeCreateInfo*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES: {
      reservedmarshal_VkPhysicalDeviceBufferDeviceAddressFeatures(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceBufferDeviceAddressFeatures*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO: {
      reservedmarshal_VkBufferOpaqueCaptureAddressCreateInfo(
          vkStream, rootType,
          reinterpret_cast<const VkBufferOpaqueCaptureAddressCreateInfo*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO: {
      reservedmarshal_VkMemoryOpaqueCaptureAddressAllocateInfo(
          vkStream, rootType,
          reinterpret_cast<const VkMemoryOpaqueCaptureAddressAllocateInfo*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_swapchain
    ...
    case VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_INFO_KHR: {
      reservedmarshal_VkDeviceGroupPresentInfoKHR(
          vkStream, rootType, reinterpret_cast<const VkDeviceGroupPresentInfoKHR*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR: {
      reservedmarshal_VkDisplayPresentInfoKHR(
          vkStream, rootType, reinterpret_cast<const VkDisplayPresentInfoKHR*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_VIDEO_PROFILE_KHR: {
      reservedmarshal_VkVideoProfileKHR(
          vkStream, rootType, reinterpret_cast<const VkVideoProfileKHR*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_PROFILES_KHR: {
      reservedmarshal_VkVideoProfilesKHR(
          vkStream, rootType, reinterpret_cast<const VkVideoProfilesKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_dynamic_rendering
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceDynamicRenderingFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDynamicRenderingFeaturesKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDERING_INFO_KHR: {
      reservedmarshal_VkCommandBufferInheritanceRenderingInfoKHR(
          vkStream, rootType,
          reinterpret_cast<const VkCommandBufferInheritanceRenderingInfoKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR: {
      reservedmarshal_VkRenderingFragmentShadingRateAttachmentInfoKHR(
          vkStream, rootType,
          reinterpret_cast<const VkRenderingFragmentShadingRateAttachmentInfoKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_INFO_EXT: {
      reservedmarshal_VkRenderingFragmentDensityMapAttachmentInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkRenderingFragmentDensityMapAttachmentInfoEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR: {
      reservedmarshal_VkImportMemoryFdInfoKHR(
          vkStream, rootType, reinterpret_cast<const VkImportMemoryFdInfoKHR*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR: {
      reservedmarshal_VkWin32KeyedMutexAcquireReleaseInfoKHR(
          vkStream, rootType,
          reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_external_semaphore_win32
    ...
    case VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHR: {
      reservedmarshal_VkD3D12FenceSubmitInfoKHR(
          vkStream, rootType, reinterpret_cast<const VkD3D12FenceSubmitInfoKHR*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES_KHR: {
      reservedmarshal_VkPhysicalDevicePushDescriptorPropertiesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePushDescriptorPropertiesKHR*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PRESENT_REGIONS_KHR: {
      reservedmarshal_VkPresentRegionsKHR(
          vkStream, rootType, reinterpret_cast<const VkPresentRegionsKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_shared_presentable_image
    case VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR: {
      reservedmarshal_VkSharedPresentSurfaceCapabilitiesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkSharedPresentSurfaceCapabilitiesKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_external_fence_win32
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDevicePerformanceQueryFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePerformanceQueryFeaturesKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR: {
      reservedmarshal_VkPhysicalDevicePerformanceQueryPropertiesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePerformanceQueryPropertiesKHR*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDevicePortabilitySubsetFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePortabilitySubsetFeaturesKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PORTABILITY_SUBSET_PROPERTIES_KHR: {
      reservedmarshal_VkPhysicalDevicePortabilitySubsetPropertiesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePortabilitySubsetPropertiesKHR*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceShaderClockFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderClockFeaturesKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_shader_terminate_invocation
    ...
    case VK_STRUCTURE_TYPE_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR: {
      reservedmarshal_VkFragmentShadingRateAttachmentInfoKHR(
          vkStream, rootType,
          reinterpret_cast<const VkFragmentShadingRateAttachmentInfoKHR*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_STATE_CREATE_INFO_KHR: {
      reservedmarshal_VkPipelineFragmentShadingRateStateCreateInfoKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineFragmentShadingRateStateCreateInfoKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceFragmentShadingRateFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceFragmentShadingRateFeaturesKHR*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDevicePresentWaitFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePresentWaitFeaturesKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_pipeline_executable_properties
    ...
    case VK_STRUCTURE_TYPE_PRESENT_ID_KHR: {
      reservedmarshal_VkPresentIdKHR(vkStream, rootType,
                                     reinterpret_cast<const VkPresentIdKHR*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDevicePresentIdFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePresentIdFeaturesKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_video_encode_queue
    ...
    case VK_STRUCTURE_TYPE_MEMORY_BARRIER_2_KHR: {
      reservedmarshal_VkMemoryBarrier2KHR(
          vkStream, rootType, reinterpret_cast<const VkMemoryBarrier2KHR*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceSynchronization2FeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSynchronization2FeaturesKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV: {
      reservedmarshal_VkQueueFamilyCheckpointProperties2NV(
          vkStream, rootType,
          reinterpret_cast<const VkQueueFamilyCheckpointProperties2NV*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_KHR_shader_subgroup_uniform_control_flow
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR*>(
              structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_3_KHR: {
      reservedmarshal_VkFormatProperties3KHR(
          vkStream, rootType, reinterpret_cast<const VkFormatProperties3KHR*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceMaintenance4FeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMaintenance4FeaturesKHR*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES_KHR: {
      reservedmarshal_VkPhysicalDeviceMaintenance4PropertiesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMaintenance4PropertiesKHR*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_ANDROID_native_buffer
    case VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID: {
      reservedmarshal_VkNativeBufferANDROID(
          vkStream, rootType, reinterpret_cast<const VkNativeBufferANDROID*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_debug_report
    ...
    case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV: {
      reservedmarshal_VkDedicatedAllocationImageCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkDedicatedAllocationImageCreateInfoNV*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV: {
      reservedmarshal_VkDedicatedAllocationBufferCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkDedicatedAllocationBufferCreateInfoNV*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_MEMORY_ALLOCATE_INFO_NV: {
      reservedmarshal_VkDedicatedAllocationMemoryAllocateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkDedicatedAllocationMemoryAllocateInfoNV*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_transform_feedback
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceTransformFeedbackFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceTransformFeedbackFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceTransformFeedbackPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceTransformFeedbackPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_STREAM_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineRasterizationStateStreamCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineRasterizationStateStreamCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoEncodeH264SessionCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH264SessionCreateInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_ADD_INFO_EXT: {
      reservedmarshal_VkVideoEncodeH264SessionParametersAddInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH264SessionParametersAddInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoEncodeH264SessionParametersCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH264SessionParametersCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_EMIT_PICTURE_PARAMETERS_EXT: {
      reservedmarshal_VkVideoEncodeH264EmitPictureParametersEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH264EmitPictureParametersEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PROFILE_EXT: {
      reservedmarshal_VkVideoEncodeH264ProfileEXT(
          vkStream, rootType, reinterpret_cast<const VkVideoEncodeH264ProfileEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoEncodeH265SessionCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH265SessionCreateInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_EXT: {
      reservedmarshal_VkVideoEncodeH265SessionParametersAddInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH265SessionParametersAddInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoEncodeH265SessionParametersCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH265SessionParametersCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_EMIT_PICTURE_PARAMETERS_EXT: {
      reservedmarshal_VkVideoEncodeH265EmitPictureParametersEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoEncodeH265EmitPictureParametersEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PROFILE_EXT: {
      reservedmarshal_VkVideoEncodeH265ProfileEXT(
          vkStream, rootType, reinterpret_cast<const VkVideoEncodeH265ProfileEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PROFILE_EXT: {
      reservedmarshal_VkVideoDecodeH264ProfileEXT(
          vkStream, rootType, reinterpret_cast<const VkVideoDecodeH264ProfileEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoDecodeH264SessionCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoDecodeH264SessionCreateInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_PARAMETERS_ADD_INFO_EXT: {
      reservedmarshal_VkVideoDecodeH264SessionParametersAddInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoDecodeH264SessionParametersAddInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_PARAMETERS_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoDecodeH264SessionParametersCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoDecodeH264SessionParametersCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_MVC_EXT: {
      reservedmarshal_VkVideoDecodeH264MvcEXT(
          vkStream, rootType, reinterpret_cast<const VkVideoDecodeH264MvcEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD: {
      reservedmarshal_VkTextureLODGatherFormatPropertiesAMD(
          vkStream, rootType,
          reinterpret_cast<const VkTextureLODGatherFormatPropertiesAMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_NV_corner_sampled_image
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CORNER_SAMPLED_IMAGE_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceCornerSampledImageFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCornerSampledImageFeaturesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV: {
      reservedmarshal_VkWin32KeyedMutexAcquireReleaseInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoNV*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_validation_flags
    case VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT: {
      reservedmarshal_VkValidationFlagsEXT(
          vkStream, rootType, reinterpret_cast<const VkValidationFlagsEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_texture_compression_astc_hdr
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ASTC_DECODE_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceASTCDecodeFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceASTCDecodeFeaturesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_conditional_rendering
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_RENDERING_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceConditionalRenderingFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceConditionalRenderingFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_W_SCALING_STATE_CREATE_INFO_NV: {
      reservedmarshal_VkPipelineViewportWScalingStateCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineViewportWScalingStateCreateInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PRESENT_TIMES_INFO_GOOGLE: {
      reservedmarshal_VkPresentTimesInfoGOOGLE(
          vkStream, rootType, reinterpret_cast<const VkPresentTimesInfoGOOGLE*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_SWIZZLE_STATE_CREATE_INFO_NV: {
      reservedmarshal_VkPipelineViewportSwizzleStateCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineViewportSwizzleStateCreateInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceDiscardRectanglePropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDiscardRectanglePropertiesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PIPELINE_DISCARD_RECTANGLE_STATE_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineDiscardRectangleStateCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineDiscardRectangleStateCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_ENABLE_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceDepthClipEnableFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDepthClipEnableFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_ANDROID: {
      reservedmarshal_VkAndroidHardwareBufferFormatPropertiesANDROID(
          vkStream, rootType,
          reinterpret_cast<const VkAndroidHardwareBufferFormatPropertiesANDROID*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_IMPORT_ANDROID_HARDWARE_BUFFER_INFO_ANDROID: {
      reservedmarshal_VkImportAndroidHardwareBufferInfoANDROID(
          vkStream, rootType,
          reinterpret_cast<const VkImportAndroidHardwareBufferInfoANDROID*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID: {
      reservedmarshal_VkExternalFormatANDROID(
          vkStream, rootType, reinterpret_cast<const VkExternalFormatANDROID*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_FORMAT_PROPERTIES_2_ANDROID: {
      reservedmarshal_VkAndroidHardwareBufferFormatProperties2ANDROID(
          vkStream, rootType,
          reinterpret_cast<const VkAndroidHardwareBufferFormatProperties2ANDROID*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceInlineUniformBlockFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceInlineUniformBlockFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceInlineUniformBlockPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceInlineUniformBlockPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK_EXT: {
      reservedmarshal_VkWriteDescriptorSetInlineUniformBlockEXT(
          vkStream, rootType,
          reinterpret_cast<const VkWriteDescriptorSetInlineUniformBlockEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO_EXT: {
      reservedmarshal_VkDescriptorPoolInlineUniformBlockCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkDescriptorPoolInlineUniformBlockCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT: {
      reservedmarshal_VkSampleLocationsInfoEXT(
          vkStream, rootType, reinterpret_cast<const VkSampleLocationsInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT: {
      reservedmarshal_VkRenderPassSampleLocationsBeginInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkRenderPassSampleLocationsBeginInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PIPELINE_SAMPLE_LOCATIONS_STATE_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineSampleLocationsStateCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineSampleLocationsStateCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceSampleLocationsPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSampleLocationsPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineColorBlendAdvancedStateCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineColorBlendAdvancedStateCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_TO_COLOR_STATE_CREATE_INFO_NV: {
      reservedmarshal_VkPipelineCoverageToColorStateCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineCoverageToColorStateCreateInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_MODULATION_STATE_CREATE_INFO_NV: {
      reservedmarshal_VkPipelineCoverageModulationStateCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineCoverageModulationStateCreateInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_PROPERTIES_NV: {
      reservedmarshal_VkPhysicalDeviceShaderSMBuiltinsPropertiesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderSMBuiltinsPropertiesNV*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SM_BUILTINS_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceShaderSMBuiltinsFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderSMBuiltinsFeaturesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_EXT: {
      reservedmarshal_VkDrmFormatModifierPropertiesListEXT(
          vkStream, rootType,
          reinterpret_cast<const VkDrmFormatModifierPropertiesListEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_DRM_FORMAT_MODIFIER_INFO_EXT: {
      reservedmarshal_VkPhysicalDeviceImageDrmFormatModifierInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceImageDrmFormatModifierInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_LIST_CREATE_INFO_EXT: {
      reservedmarshal_VkImageDrmFormatModifierListCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkImageDrmFormatModifierListCreateInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_EXPLICIT_CREATE_INFO_EXT: {
      reservedmarshal_VkImageDrmFormatModifierExplicitCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkImageDrmFormatModifierExplicitCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_2_EXT: {
      reservedmarshal_VkDrmFormatModifierPropertiesList2EXT(
          vkStream, rootType,
          reinterpret_cast<const VkDrmFormatModifierPropertiesList2EXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_validation_cache
    case VK_STRUCTURE_TYPE_SHADER_MODULE_VALIDATION_CACHE_CREATE_INFO_EXT: {
      reservedmarshal_VkShaderModuleValidationCacheCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkShaderModuleValidationCacheCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceShadingRateImageFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShadingRateImageFeaturesNV*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADING_RATE_IMAGE_PROPERTIES_NV: {
      reservedmarshal_VkPhysicalDeviceShadingRateImagePropertiesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShadingRateImagePropertiesNV*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_NV: {
      reservedmarshal_VkWriteDescriptorSetAccelerationStructureNV(
          vkStream, rootType,
          reinterpret_cast<const VkWriteDescriptorSetAccelerationStructureNV*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_NV: {
      reservedmarshal_VkPhysicalDeviceRayTracingPropertiesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRayTracingPropertiesNV*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_NV_representative_fragment_test
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_IMAGE_FORMAT_INFO_EXT: {
      reservedmarshal_VkPhysicalDeviceImageViewImageFormatInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceImageViewImageFormatInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_FILTER_CUBIC_IMAGE_VIEW_IMAGE_FORMAT_PROPERTIES_EXT: {
      reservedmarshal_VkFilterCubicImageViewImageFormatPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkFilterCubicImageViewImageFormatPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO_EXT: {
      reservedmarshal_VkDeviceQueueGlobalPriorityCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkDeviceQueueGlobalPriorityCreateInfoEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_external_memory_host
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceExternalMemoryHostPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceExternalMemoryHostPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD: {
      reservedmarshal_VkPipelineCompilerControlCreateInfoAMD(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineCompilerControlCreateInfoAMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_AMD_shader_core_properties
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD: {
      reservedmarshal_VkPhysicalDeviceShaderCorePropertiesAMD(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderCorePropertiesAMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_video_decode_h265
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PROFILE_EXT: {
      reservedmarshal_VkVideoDecodeH265ProfileEXT(
          vkStream, rootType, reinterpret_cast<const VkVideoDecodeH265ProfileEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoDecodeH265SessionCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoDecodeH265SessionCreateInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_PARAMETERS_ADD_INFO_EXT: {
      reservedmarshal_VkVideoDecodeH265SessionParametersAddInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoDecodeH265SessionParametersAddInfoEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_PARAMETERS_CREATE_INFO_EXT: {
      reservedmarshal_VkVideoDecodeH265SessionParametersCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkVideoDecodeH265SessionParametersCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DEVICE_MEMORY_OVERALLOCATION_CREATE_INFO_AMD: {
      reservedmarshal_VkDeviceMemoryOverallocationCreateInfoAMD(
          vkStream, rootType,
          reinterpret_cast<const VkDeviceMemoryOverallocationCreateInfoAMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_vertex_attribute_divisor
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineVertexInputDivisorStateCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineVertexInputDivisorStateCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PRESENT_FRAME_TOKEN_GGP: {
      reservedmarshal_VkPresentFrameTokenGGP(
          vkStream, rootType, reinterpret_cast<const VkPresentFrameTokenGGP*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineCreationFeedbackCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineCreationFeedbackCreateInfoEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_NV_compute_shader_derivatives
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceMeshShaderFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMeshShaderFeaturesNV*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV: {
      reservedmarshal_VkPhysicalDeviceMeshShaderPropertiesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMeshShaderPropertiesNV*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_NV_fragment_shader_barycentric
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_FOOTPRINT_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceShaderImageFootprintFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderImageFootprintFeaturesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXCLUSIVE_SCISSOR_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceExclusiveScissorFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceExclusiveScissorFeaturesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_QUERY_CREATE_INFO_INTEL: {
      reservedmarshal_VkQueryPoolPerformanceQueryCreateInfoINTEL(
          vkStream, rootType,
          reinterpret_cast<const VkQueryPoolPerformanceQueryCreateInfoINTEL*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PCI_BUS_INFO_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDevicePCIBusInfoPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePCIBusInfoPropertiesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_AMD_display_native_hdr
    case VK_STRUCTURE_TYPE_DISPLAY_NATIVE_HDR_SURFACE_CAPABILITIES_AMD: {
      reservedmarshal_VkDisplayNativeHdrSurfaceCapabilitiesAMD(
          vkStream, rootType,
          reinterpret_cast<const VkDisplayNativeHdrSurfaceCapabilitiesAMD*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_SWAPCHAIN_DISPLAY_NATIVE_HDR_CREATE_INFO_AMD: {
      reservedmarshal_VkSwapchainDisplayNativeHdrCreateInfoAMD(
          vkStream, rootType,
          reinterpret_cast<const VkSwapchainDisplayNativeHdrCreateInfoAMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_fragment_density_map
      ...
      switch (rootType) {
        case VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO: {
          reservedmarshal_VkRenderPassFragmentDensityMapCreateInfoEXT(
              vkStream, rootType,
              reinterpret_cast<const VkRenderPassFragmentDensityMapCreateInfoEXT*>(structExtension),
              ptr);
          break;
        }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceSubgroupSizeControlFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSubgroupSizeControlFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_2_AMD: {
      reservedmarshal_VkPhysicalDeviceShaderCoreProperties2AMD(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderCoreProperties2AMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_AMD_device_coherent_memory
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COHERENT_MEMORY_FEATURES_AMD: {
      reservedmarshal_VkPhysicalDeviceCoherentMemoryFeaturesAMD(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCoherentMemoryFeaturesAMD*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_shader_image_atomic_int64
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_BUDGET_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceMemoryBudgetPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMemoryBudgetPropertiesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_memory_priority
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PRIORITY_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceMemoryPriorityFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMemoryPriorityFeaturesEXT*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceBufferDeviceAddressFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceBufferDeviceAddressFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VALIDATION_FEATURES_EXT: {
      reservedmarshal_VkValidationFeaturesEXT(
          vkStream, rootType, reinterpret_cast<const VkValidationFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceCooperativeMatrixFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCooperativeMatrixFeaturesNV*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_NV: {
      reservedmarshal_VkPhysicalDeviceCooperativeMatrixPropertiesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCooperativeMatrixPropertiesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COVERAGE_REDUCTION_MODE_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceCoverageReductionModeFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCoverageReductionModeFeaturesNV*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PIPELINE_COVERAGE_REDUCTION_STATE_CREATE_INFO_NV: {
      reservedmarshal_VkPipelineCoverageReductionStateCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineCoverageReductionStateCreateInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_IMAGE_ARRAYS_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceYcbcrImageArraysFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceYcbcrImageArraysFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceProvokingVertexFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceProvokingVertexFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceProvokingVertexPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceProvokingVertexPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_FULL_SCREEN_EXCLUSIVE_EXT: {
      reservedmarshal_VkSurfaceCapabilitiesFullScreenExclusiveEXT(
          vkStream, rootType,
          reinterpret_cast<const VkSurfaceCapabilitiesFullScreenExclusiveEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_WIN32_INFO_EXT: {
      reservedmarshal_VkSurfaceFullScreenExclusiveWin32InfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkSurfaceFullScreenExclusiveWin32InfoEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_line_rasterization
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceLineRasterizationFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceLineRasterizationFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceLineRasterizationPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceLineRasterizationPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO_EXT: {
      reservedmarshal_VkPipelineRasterizationLineStateCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPipelineRasterizationLineStateCreateInfoEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceShaderAtomicFloatFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderAtomicFloatFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceIndexTypeUint8FeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceIndexTypeUint8FeaturesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_extended_dynamic_state
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceExtendedDynamicStateFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceExtendedDynamicStateFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_2_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_SHADER_GROUPS_CREATE_INFO_NV: {
      reservedmarshal_VkGraphicsPipelineShaderGroupsCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkGraphicsPipelineShaderGroupsCreateInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_VIEWPORT_SCISSOR_INFO_NV: {
      reservedmarshal_VkCommandBufferInheritanceViewportScissorInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkCommandBufferInheritanceViewportScissorInfoNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceDeviceMemoryReportFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDeviceMemoryReportFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT: {
      reservedmarshal_VkDeviceDeviceMemoryReportCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkDeviceDeviceMemoryReportCreateInfoEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_robustness2
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceRobustness2FeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRobustness2FeaturesEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceRobustness2PropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRobustness2PropertiesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_custom_border_color
    case VK_STRUCTURE_TYPE_SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT: {
      reservedmarshal_VkSamplerCustomBorderColorCreateInfoEXT(
          vkStream, rootType,
          reinterpret_cast<const VkSamplerCustomBorderColorCreateInfoEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceCustomBorderColorPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCustomBorderColorPropertiesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceCustomBorderColorFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceCustomBorderColorFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDevicePrivateDataFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevicePrivateDataFeaturesEXT*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DIAGNOSTICS_CONFIG_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceDiagnosticsConfigFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceDiagnosticsConfigFeaturesNV*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV: {
      reservedmarshal_VkDeviceDiagnosticsConfigCreateInfoNV(
          vkStream, rootType,
          reinterpret_cast<const VkDeviceDiagnosticsConfigCreateInfoNV*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_NV_fragment_shading_rate_enums
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_MOTION_BLUR_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceRayTracingMotionBlurFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRayTracingMotionBlurFeaturesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceFragmentDensityMap2FeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceFragmentDensityMap2FeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceImageRobustnessFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceImageRobustnessFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDevice4444FormatsFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDevice4444FormatsFeaturesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_rgba10x6_formats
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RGBA10X6_FORMATS_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE: {
      reservedmarshal_VkMutableDescriptorTypeCreateInfoVALVE(
          vkStream, rootType,
          reinterpret_cast<const VkMutableDescriptorTypeCreateInfoVALVE*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_vertex_input_dynamic_state
    ...
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA: {
      reservedmarshal_VkImportMemoryZirconHandleInfoFUCHSIA(
          vkStream, rootType,
          reinterpret_cast<const VkImportMemoryZirconHandleInfoFUCHSIA*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_FUCHSIA_buffer_collection
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_BUFFER_COLLECTION_FUCHSIA: {
      reservedmarshal_VkImportMemoryBufferCollectionFUCHSIA(
          vkStream, rootType,
          reinterpret_cast<const VkImportMemoryBufferCollectionFUCHSIA*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_BUFFER_COLLECTION_IMAGE_CREATE_INFO_FUCHSIA: {
      reservedmarshal_VkBufferCollectionImageCreateInfoFUCHSIA(
          vkStream, rootType,
          reinterpret_cast<const VkBufferCollectionImageCreateInfoFUCHSIA*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_BUFFER_COLLECTION_BUFFER_CREATE_INFO_FUCHSIA: {
      reservedmarshal_VkBufferCollectionBufferCreateInfoFUCHSIA(
          vkStream, rootType,
          reinterpret_cast<const VkBufferCollectionBufferCreateInfoFUCHSIA*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_HUAWEI_subpass_shading
    case VK_STRUCTURE_TYPE_SUBPASS_SHADING_PIPELINE_CREATE_INFO_HUAWEI: {
      reservedmarshal_VkSubpassShadingPipelineCreateInfoHUAWEI(
          vkStream, rootType,
          reinterpret_cast<const VkSubpassShadingPipelineCreateInfoHUAWEI*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_SHADING_FEATURES_HUAWEI: {
      reservedmarshal_VkPhysicalDeviceSubpassShadingFeaturesHUAWEI(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSubpassShadingFeaturesHUAWEI*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_SHADING_PROPERTIES_HUAWEI: {
      reservedmarshal_VkPhysicalDeviceSubpassShadingPropertiesHUAWEI(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceSubpassShadingPropertiesHUAWEI*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INVOCATION_MASK_FEATURES_HUAWEI: {
      reservedmarshal_VkPhysicalDeviceInvocationMaskFeaturesHUAWEI(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceInvocationMaskFeaturesHUAWEI*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_RDMA_FEATURES_NV: {
      reservedmarshal_VkPhysicalDeviceExternalMemoryRDMAFeaturesNV(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceExternalMemoryRDMAFeaturesNV*>(structExtension),
          ptr);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COLOR_WRITE_ENABLE_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceColorWriteEnableFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceColorWriteEnableFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_IMPORT_COLOR_BUFFER_GOOGLE: {
      reservedmarshal_VkImportColorBufferGOOGLE(
          vkStream, rootType, reinterpret_cast<const VkImportColorBufferGOOGLE*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_IMPORT_BUFFER_GOOGLE: {
      reservedmarshal_VkImportBufferGOOGLE(
          vkStream, rootType, reinterpret_cast<const VkImportBufferGOOGLE*>(structExtension), ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceGlobalPriorityQueryFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceGlobalPriorityQueryFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES_EXT: {
      reservedmarshal_VkQueueFamilyGlobalPriorityPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkQueueFamilyGlobalPriorityPropertiesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_multi_draw
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceMultiDrawFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMultiDrawFeaturesEXT*>(structExtension), ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT: {
      reservedmarshal_VkPhysicalDeviceMultiDrawPropertiesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceMultiDrawPropertiesEXT*>(structExtension), ptr);
      break;
    }
#endif
#ifdef VK_EXT_border_color_swizzle
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BORDER_COLOR_SWIZZLE_FEATURES_EXT: {
      reservedmarshal_VkPhysicalDeviceBorderColorSwizzleFeaturesEXT(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceBorderColorSwizzleFeaturesEXT*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR: {
      reservedmarshal_VkWriteDescriptorSetAccelerationStructureKHR(
          vkStream, rootType,
          reinterpret_cast<const VkWriteDescriptorSetAccelerationStructureKHR*>(structExtension),
          ptr);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR: {
      reservedmarshal_VkPhysicalDeviceRayTracingPipelineFeaturesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRayTracingPipelineFeaturesKHR*>(structExtension),
          ptr);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_PROPERTIES_KHR: {
      reservedmarshal_VkPhysicalDeviceRayTracingPipelinePropertiesKHR(
          vkStream, rootType,
          reinterpret_cast<const VkPhysicalDeviceRayTracingPipelinePropertiesKHR*>(structExtension),
          ptr);
      break;
    }
#endif
