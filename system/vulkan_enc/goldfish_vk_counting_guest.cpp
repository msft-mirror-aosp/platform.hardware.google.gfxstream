  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < toCount->enabledExtensionCount; ++i) {
      size_t l =
          toCount->ppEnabledExtensionNames[i] ? strlen(toCount->ppEnabledExtensionNames[i]) : 0;
      *count +=
          sizeof(uint32_t) +
          (toCount->ppEnabledExtensionNames[i] ? strlen(toCount->ppEnabledExtensionNames[i]) : 0);
    }
...
void count_VkDeviceCreateInfo(uint32_t featureBits, VkStructureType rootType,
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->queueCreateInfoCount; ++i) {
      count_VkDeviceQueueCreateInfo(
          featureBits, rootType, (const VkDeviceQueueCreateInfo*)(toCount->pQueueCreateInfos + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
  ...
  *count += 8;
  if (toCount->pEnabledFeatures) {
    count_VkPhysicalDeviceFeatures(
        featureBits, rootType, (const VkPhysicalDeviceFeatures*)(toCount->pEnabledFeatures), count);
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->bindCount; ++i) {
      count_VkSparseImageMemoryBind(featureBits, rootType,
                                    (const VkSparseImageMemoryBind*)(toCount->pBinds + i), count);
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->bufferBindCount; ++i) {
      count_VkSparseBufferMemoryBindInfo(
          featureBits, rootType, (const VkSparseBufferMemoryBindInfo*)(toCount->pBufferBinds + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->imageBindCount; ++i) {
      count_VkSparseImageMemoryBindInfo(
          featureBits, rootType, (const VkSparseImageMemoryBindInfo*)(toCount->pImageBinds + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->mapEntryCount; ++i) {
      count_VkSpecializationMapEntry(featureBits, rootType,
                                     (const VkSpecializationMapEntry*)(toCount->pMapEntries + i),
                                     count);
    }
  }
  *count += 8;
  ...
  *count += 8;
  if (toCount->pSpecializationInfo) {
    count_VkSpecializationInfo(featureBits, rootType,
                               (const VkSpecializationInfo*)(toCount->pSpecializationInfo), count);
  }
}
...
void count_VkComputePipelineCreateInfo(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkPipelineCreateFlags);
  count_VkPipelineShaderStageCreateInfo(featureBits, rootType,
                                        (VkPipelineShaderStageCreateInfo*)(&toCount->stage), count);
  uint64_t cgen_var_0;
  *count += 1 * 8;
  uint64_t cgen_var_1;
  *count += 1 * 8;
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->vertexBindingDescriptionCount; ++i) {
      count_VkVertexInputBindingDescription(
          featureBits, rootType,
          (const VkVertexInputBindingDescription*)(toCount->pVertexBindingDescriptions + i), count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->vertexAttributeDescriptionCount; ++i) {
      count_VkVertexInputAttributeDescription(
          featureBits, rootType,
          (const VkVertexInputAttributeDescription*)(toCount->pVertexAttributeDescriptions + i),
          count);
    }
  }
}
  ...
  if (toCount->pViewports) {
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->viewportCount; ++i) {
        count_VkViewport(featureBits, rootType, (const VkViewport*)(toCount->pViewports + i),
                         count);
      }
    }
  }
...
void count_VkGraphicsPipelineCreateInfo(uint32_t featureBits, VkStructureType rootType,
  ...
  if (featureBits & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) {
    hasTessellation =
        arrayany(toCount->pStages, 0, toCount->stageCount, [](VkPipelineShaderStageCreateInfo s) {
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->stageCount; ++i) {
      count_VkPipelineShaderStageCreateInfo(
          featureBits, rootType, (const VkPipelineShaderStageCreateInfo*)(toCount->pStages + i),
          count);
    }
  }
  // WARNING PTR CHECK
  ...
  *count += 8;
  if (toCount->pDynamicState) {
    count_VkPipelineDynamicStateCreateInfo(
        featureBits, rootType, (const VkPipelineDynamicStateCreateInfo*)(toCount->pDynamicState),
        count);
  }
  uint64_t cgen_var_0;
  *count += 1 * 8;
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->pushConstantRangeCount; ++i) {
      count_VkPushConstantRange(featureBits, rootType,
                                (const VkPushConstantRange*)(toCount->pPushConstantRanges + i),
                                count);
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->poolSizeCount; ++i) {
      count_VkDescriptorPoolSize(featureBits, rootType,
                                 (const VkDescriptorPoolSize*)(toCount->pPoolSizes + i), count);
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->bindingCount; ++i) {
      count_VkDescriptorSetLayoutBinding(
          featureBits, rootType, (const VkDescriptorSetLayoutBinding*)(toCount->pBindings + i),
          count);
    }
  }
}
    ...
    if ((!(featureBits & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) ||
      ...
      if (toCount) {
        for (uint32_t i = 0; i < (uint32_t)toCount->descriptorCount; ++i) {
          count_VkDescriptorImageInfo(featureBits, rootType,
                                      (const VkDescriptorImageInfo*)(toCount->pImageInfo + i),
                                      count);
        }
      }
    }
  ...
  *count += 8;
  if (toCount->pBufferInfo) {
    if ((!(featureBits & VULKAN_STREAM_FEATURE_IGNORED_HANDLES_BIT) ||
      ...
      if (toCount) {
        for (uint32_t i = 0; i < (uint32_t)toCount->descriptorCount; ++i) {
          count_VkDescriptorBufferInfo(featureBits, rootType,
                                       (const VkDescriptorBufferInfo*)(toCount->pBufferInfo + i),
                                       count);
        }
      }
    }
...
void count_VkSubpassDescription(uint32_t featureBits, VkStructureType rootType,
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->inputAttachmentCount; ++i) {
      count_VkAttachmentReference(featureBits, rootType,
                                  (const VkAttachmentReference*)(toCount->pInputAttachments + i),
                                  count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->colorAttachmentCount; ++i) {
      count_VkAttachmentReference(featureBits, rootType,
                                  (const VkAttachmentReference*)(toCount->pColorAttachments + i),
                                  count);
    }
  }
  // WARNING PTR CHECK
    ...
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->colorAttachmentCount; ++i) {
        count_VkAttachmentReference(
            featureBits, rootType, (const VkAttachmentReference*)(toCount->pResolveAttachments + i),
            count);
      }
    }
  }
  ...
  *count += 8;
  if (toCount->pDepthStencilAttachment) {
    count_VkAttachmentReference(featureBits, rootType,
                                (const VkAttachmentReference*)(toCount->pDepthStencilAttachment),
                                count);
  }
  *count += sizeof(uint32_t);
  if (toCount) {
...
void count_VkRenderPassCreateInfo(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->attachmentCount; ++i) {
      count_VkAttachmentDescription(featureBits, rootType,
                                    (const VkAttachmentDescription*)(toCount->pAttachments + i),
                                    count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->subpassCount; ++i) {
      count_VkSubpassDescription(featureBits, rootType,
                                 (const VkSubpassDescription*)(toCount->pSubpasses + i), count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->dependencyCount; ++i) {
      count_VkSubpassDependency(featureBits, rootType,
                                (const VkSubpassDependency*)(toCount->pDependencies + i), count);
    }
  }
}
  ...
  *count += 8;
  if (toCount->pInheritanceInfo) {
    count_VkCommandBufferInheritanceInfo(
        featureBits, rootType, (const VkCommandBufferInheritanceInfo*)(toCount->pInheritanceInfo),
        count);
  }
}
  ...
  if (toCount->pClearValues) {
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->clearValueCount; ++i) {
        count_VkClearValue(featureBits, rootType, (const VkClearValue*)(toCount->pClearValues + i),
                           count);
      }
    }
  }
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->deviceRenderAreaCount; ++i) {
      count_VkRect2D(featureBits, rootType, (const VkRect2D*)(toCount->pDeviceRenderAreas + i),
                     count);
    }
  }
}
...
void count_VkFormatProperties2(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkFormatProperties(featureBits, rootType, (VkFormatProperties*)(&toCount->formatProperties),
                           count);
}
...
void count_VkImageFormatProperties2(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkImageFormatProperties(featureBits, rootType,
                                (VkImageFormatProperties*)(&toCount->imageFormatProperties), count);
}
...
void count_VkQueueFamilyProperties2(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkQueueFamilyProperties(featureBits, rootType,
                                (VkQueueFamilyProperties*)(&toCount->queueFamilyProperties), count);
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->descriptorUpdateEntryCount; ++i) {
      count_VkDescriptorUpdateTemplateEntry(
          featureBits, rootType,
          (const VkDescriptorUpdateTemplateEntry*)(toCount->pDescriptorUpdateEntries + i), count);
    }
  }
...
void count_VkSubpassDescription2(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->inputAttachmentCount; ++i) {
      count_VkAttachmentReference2(featureBits, rootType,
                                   (const VkAttachmentReference2*)(toCount->pInputAttachments + i),
                                   count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->colorAttachmentCount; ++i) {
      count_VkAttachmentReference2(featureBits, rootType,
                                   (const VkAttachmentReference2*)(toCount->pColorAttachments + i),
                                   count);
    }
  }
  // WARNING PTR CHECK
  ...
  *count += 8;
  if (toCount->pDepthStencilAttachment) {
    count_VkAttachmentReference2(featureBits, rootType,
                                 (const VkAttachmentReference2*)(toCount->pDepthStencilAttachment),
                                 count);
  }
  *count += sizeof(uint32_t);
  if (toCount) {
...
void count_VkRenderPassCreateInfo2(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->attachmentCount; ++i) {
      count_VkAttachmentDescription2(featureBits, rootType,
                                     (const VkAttachmentDescription2*)(toCount->pAttachments + i),
                                     count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->subpassCount; ++i) {
      count_VkSubpassDescription2(featureBits, rootType,
                                  (const VkSubpassDescription2*)(toCount->pSubpasses + i), count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->dependencyCount; ++i) {
      count_VkSubpassDependency2(featureBits, rootType,
                                 (const VkSubpassDependency2*)(toCount->pDependencies + i), count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->attachmentImageInfoCount; ++i) {
      count_VkFramebufferAttachmentImageInfo(
          featureBits, rootType,
          (const VkFramebufferAttachmentImageInfo*)(toCount->pAttachmentImageInfos + i), count);
    }
  }
}
...
void count_VkVideoReferenceSlotKHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(int8_t);
  count_VkVideoPictureResourceKHR(
      featureBits, rootType, (const VkVideoPictureResourceKHR*)(toCount->pPictureResource), count);
}
...
void count_VkVideoSessionCreateInfoKHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkVideoSessionCreateFlagsKHR);
  count_VkVideoProfileKHR(featureBits, rootType, (const VkVideoProfileKHR*)(toCount->pVideoProfile),
                          count);
  *count += sizeof(VkFormat);
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->referenceSlotCount; ++i) {
      count_VkVideoReferenceSlotKHR(featureBits, rootType,
                                    (const VkVideoReferenceSlotKHR*)(toCount->pReferenceSlots + i),
                                    count);
    }
  }
}
...
void count_VkVideoDecodeInfoKHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkDeviceSize);
  ...
  count_VkVideoReferenceSlotKHR(
      featureBits, rootType, (const VkVideoReferenceSlotKHR*)(toCount->pSetupReferenceSlot), count);
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->referenceSlotCount; ++i) {
      count_VkVideoReferenceSlotKHR(featureBits, rootType,
...
void count_VkRenderingInfoKHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += 8;
  if (toCount->pStencilAttachment) {
    count_VkRenderingAttachmentInfoKHR(
        featureBits, rootType, (const VkRenderingAttachmentInfoKHR*)(toCount->pStencilAttachment),
        count);
  }
}
...
void count_VkSurfaceCapabilities2KHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkSurfaceCapabilitiesKHR(featureBits, rootType,
                                 (VkSurfaceCapabilitiesKHR*)(&toCount->surfaceCapabilities), count);
}
...
void count_VkDisplayModeProperties2KHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkDisplayModePropertiesKHR(
      featureBits, rootType, (VkDisplayModePropertiesKHR*)(&toCount->displayModeProperties), count);
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->memoryBarrierCount; ++i) {
      count_VkMemoryBarrier2KHR(featureBits, rootType,
                                (const VkMemoryBarrier2KHR*)(toCount->pMemoryBarriers + i), count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
...
void count_VkCopyImageInfo2KHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->regionCount; ++i) {
      count_VkImageCopy2KHR(featureBits, rootType, (const VkImageCopy2KHR*)(toCount->pRegions + i),
                            count);
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->regionCount; ++i) {
      count_VkBufferImageCopy2KHR(featureBits, rootType,
                                  (const VkBufferImageCopy2KHR*)(toCount->pRegions + i), count);
    }
  }
}
...
void count_VkBlitImageInfo2KHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->regionCount; ++i) {
      count_VkImageBlit2KHR(featureBits, rootType, (const VkImageBlit2KHR*)(toCount->pRegions + i),
                            count);
    }
  }
  *count += sizeof(VkFilter);
...
void count_VkDeviceBufferMemoryRequirementsKHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkBufferCreateInfo(featureBits, rootType, (const VkBufferCreateInfo*)(toCount->pCreateInfo),
                           count);
}
...
void count_VkVideoEncodeH264SessionCreateInfoEXT(
  ...
  *count += sizeof(VkVideoEncodeH264CreateFlagsEXT);
  count_VkExtent2D(featureBits, rootType, (VkExtent2D*)(&toCount->maxPictureSizeInMbs), count);
  count_VkExtensionProperties(featureBits, rootType,
                              (const VkExtensionProperties*)(toCount->pStdExtensionVersion), count);
}
  ...
  *count += 8;
  if (toCount->pParametersAddInfo) {
    count_VkVideoEncodeH264SessionParametersAddInfoEXT(
        featureBits, rootType,
        (const VkVideoEncodeH264SessionParametersAddInfoEXT*)(toCount->pParametersAddInfo), count);
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->refFinalList0EntryCount; ++i) {
      count_VkVideoEncodeH264DpbSlotInfoEXT(
          featureBits, rootType,
          (const VkVideoEncodeH264DpbSlotInfoEXT*)(toCount->pRefFinalList0Entries + i), count);
    }
  }
  *count += sizeof(uint8_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->refFinalList1EntryCount; ++i) {
      count_VkVideoEncodeH264DpbSlotInfoEXT(
          featureBits, rootType,
          (const VkVideoEncodeH264DpbSlotInfoEXT*)(toCount->pRefFinalList1Entries + i), count);
    }
  }
  *count += sizeof(uint32_t);
  *count += sizeof(uint8_t);
...
void count_VkVideoEncodeH264VclFrameInfoEXT(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  ...
  count_VkVideoEncodeH264DpbSlotInfoEXT(
      featureBits, rootType, (const VkVideoEncodeH264DpbSlotInfoEXT*)(toCount->pCurrentPictureInfo),
      count);
}
  ...
  *count += 8;
  if (toCount->pParametersAddInfo) {
    count_VkVideoEncodeH265SessionParametersAddInfoEXT(
        featureBits, rootType,
        (const VkVideoEncodeH265SessionParametersAddInfoEXT*)(toCount->pParametersAddInfo), count);
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->referenceList0EntryCount; ++i) {
      count_VkVideoEncodeH265DpbSlotInfoEXT(
          featureBits, rootType,
          (const VkVideoEncodeH265DpbSlotInfoEXT*)(toCount->pReferenceList0Entries + i), count);
    }
  }
  *count += sizeof(uint8_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->referenceList1EntryCount; ++i) {
      count_VkVideoEncodeH265DpbSlotInfoEXT(
          featureBits, rootType,
          (const VkVideoEncodeH265DpbSlotInfoEXT*)(toCount->pReferenceList1Entries + i), count);
    }
  }
  ...
  *count += 8;
  if (toCount->pParametersAddInfo) {
    count_VkVideoDecodeH264SessionParametersAddInfoEXT(
        featureBits, rootType,
        (const VkVideoDecodeH264SessionParametersAddInfoEXT*)(toCount->pParametersAddInfo), count);
  }
}
...
void count_VkPipelineViewportWScalingStateCreateInfoNV(
  ...
  *count += 8;
  if (toCount->pViewportWScalings) {
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->viewportCount; ++i) {
        count_VkViewportWScalingNV(featureBits, rootType,
                                   (const VkViewportWScalingNV*)(toCount->pViewportWScalings + i),
                                   count);
      }
    }
  }
  ...
  if (toCount->pDiscardRectangles) {
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->discardRectangleCount; ++i) {
        count_VkRect2D(featureBits, rootType, (const VkRect2D*)(toCount->pDiscardRectangles + i),
                       count);
      }
    }
  }
    ...
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->queueLabelCount; ++i) {
        count_VkDebugUtilsLabelEXT(featureBits, rootType,
                                   (VkDebugUtilsLabelEXT*)(toCount->pQueueLabels + i), count);
      }
    }
  }
  *count += sizeof(uint32_t);
  ...
  if (toCount->pCmdBufLabels) {
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->cmdBufLabelCount; ++i) {
        count_VkDebugUtilsLabelEXT(featureBits, rootType,
                                   (VkDebugUtilsLabelEXT*)(toCount->pCmdBufLabels + i), count);
      }
    }
  }
  *count += sizeof(uint32_t);
    ...
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->objectCount; ++i) {
        count_VkDebugUtilsObjectNameInfoEXT(
            featureBits, rootType, (VkDebugUtilsObjectNameInfoEXT*)(toCount->pObjects + i), count);
      }
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->sampleLocationsCount; ++i) {
      count_VkSampleLocationEXT(featureBits, rootType,
                                (const VkSampleLocationEXT*)(toCount->pSampleLocations + i), count);
    }
  }
}
...
void count_VkAttachmentSampleLocationsEXT(uint32_t featureBits, VkStructureType rootType,
  ...
  (void)count;
  *count += sizeof(uint32_t);
  count_VkSampleLocationsInfoEXT(featureBits, rootType,
                                 (VkSampleLocationsInfoEXT*)(&toCount->sampleLocationsInfo), count);
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->attachmentInitialSampleLocationsCount; ++i) {
      count_VkAttachmentSampleLocationsEXT(
          featureBits, rootType,
          (const VkAttachmentSampleLocationsEXT*)(toCount->pAttachmentInitialSampleLocations + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->postSubpassSampleLocationsCount; ++i) {
      count_VkSubpassSampleLocationsEXT(
          featureBits, rootType,
          (const VkSubpassSampleLocationsEXT*)(toCount->pPostSubpassSampleLocations + i), count);
    }
  }
}
    ...
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->drmFormatModifierCount; ++i) {
        count_VkDrmFormatModifierPropertiesEXT(
            featureBits, rootType,
            (VkDrmFormatModifierPropertiesEXT*)(toCount->pDrmFormatModifierProperties + i), count);
      }
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->drmFormatModifierPlaneCount; ++i) {
      count_VkSubresourceLayout(featureBits, rootType,
                                (const VkSubresourceLayout*)(toCount->pPlaneLayouts + i), count);
    }
  }
}
    ...
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->drmFormatModifierCount; ++i) {
        count_VkDrmFormatModifierProperties2EXT(
            featureBits, rootType,
            (VkDrmFormatModifierProperties2EXT*)(toCount->pDrmFormatModifierProperties + i), count);
      }
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->sampleLocationCount; ++i) {
      count_VkCoarseSampleLocationNV(
          featureBits, rootType, (const VkCoarseSampleLocationNV*)(toCount->pSampleLocations + i),
          count);
    }
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->groupCount; ++i) {
      count_VkRayTracingShaderGroupCreateInfoNV(
          featureBits, rootType, (const VkRayTracingShaderGroupCreateInfoNV*)(toCount->pGroups + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
...
void count_VkGeometryDataNV(uint32_t featureBits, VkStructureType rootType,
  ...
  (void)toCount;
  (void)count;
  count_VkGeometryTrianglesNV(featureBits, rootType, (VkGeometryTrianglesNV*)(&toCount->triangles),
                              count);
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->geometryCount; ++i) {
      count_VkGeometryNV(featureBits, rootType, (const VkGeometryNV*)(toCount->pGeometries + i),
                         count);
    }
  }
}
  ...
  *count += 8;
  if (toCount->pParametersAddInfo) {
    count_VkVideoDecodeH265SessionParametersAddInfoEXT(
        featureBits, rootType,
        (const VkVideoDecodeH265SessionParametersAddInfoEXT*)(toCount->pParametersAddInfo), count);
  }
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->vertexBindingDivisorCount; ++i) {
      count_VkVertexInputBindingDivisorDescriptionEXT(
          featureBits, rootType,
          (const VkVertexInputBindingDivisorDescriptionEXT*)(toCount->pVertexBindingDivisors + i),
          count);
    }
  }
}
  ...
  *count += sizeof(uint32_t);
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->pipelineStageCreationFeedbackCount; ++i) {
      count_VkPipelineCreationFeedbackEXT(
          featureBits, rootType,
          (VkPipelineCreationFeedbackEXT*)(toCount->pPipelineStageCreationFeedbacks + i), count);
    }
  }
}
  ...
  if (toCount->pExclusiveScissors) {
    if (toCount) {
      for (uint32_t i = 0; i < (uint32_t)toCount->exclusiveScissorCount; ++i) {
        count_VkRect2D(featureBits, rootType, (const VkRect2D*)(toCount->pExclusiveScissors + i),
                       count);
      }
    }
  }
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->groupCount; ++i) {
      count_VkGraphicsShaderGroupCreateInfoNV(
          featureBits, rootType, (const VkGraphicsShaderGroupCreateInfoNV*)(toCount->pGroups + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->tokenCount; ++i) {
      count_VkIndirectCommandsLayoutTokenNV(
          featureBits, rootType, (const VkIndirectCommandsLayoutTokenNV*)(toCount->pTokens + i),
          count);
    }
  }
  *count += sizeof(uint32_t);
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->streamCount; ++i) {
      count_VkIndirectCommandsStreamNV(
          featureBits, rootType, (const VkIndirectCommandsStreamNV*)(toCount->pStreams + i), count);
    }
  }
  *count += sizeof(uint32_t);
  uint64_t cgen_var_2;
...
void count_VkSamplerCustomBorderColorCreateInfoEXT(
  ...
  *count += sizeof(VkStructureType);
  ...
  count_extension_struct(featureBits, rootType, toCount->pNext, count);
  count_VkClearColorValue(featureBits, rootType, (VkClearColorValue*)(&toCount->customBorderColor),
                          count);
  *count += sizeof(VkFormat);
}
...
void count_VkAccelerationStructureMatrixMotionInstanceNV(
  ...
  (void)toCount;
  (void)count;
  count_VkTransformMatrixKHR(featureBits, rootType, (VkTransformMatrixKHR*)(&toCount->transformT0),
                             count);
  count_VkTransformMatrixKHR(featureBits, rootType, (VkTransformMatrixKHR*)(&toCount->transformT1),
                             count);
  *count += sizeof(uint32_t);
  *count += sizeof(uint32_t);
  *count += sizeof(uint32_t);
...
void count_VkAccelerationStructureMotionInstanceNV(
  ...
  *count += sizeof(VkAccelerationStructureMotionInstanceFlagsNV);
  count_VkAccelerationStructureMotionInstanceDataNV(
      featureBits, rootType, (VkAccelerationStructureMotionInstanceDataNV*)(&toCount->data), count);
}
...
void count_VkBufferCollectionPropertiesFUCHSIA(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkFormatFeatureFlags);
  count_VkSysmemColorSpaceFUCHSIA(
      featureBits, rootType, (VkSysmemColorSpaceFUCHSIA*)(&toCount->sysmemColorSpaceIndex), count);
  count_VkComponentMapping(featureBits, rootType,
                           (VkComponentMapping*)(&toCount->samplerYcbcrConversionComponents),
                           count);
  *count += sizeof(VkSamplerYcbcrModelConversion);
...
void count_VkImageFormatConstraintsInfoFUCHSIA(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(uint32_t);
  count_VkSysmemColorSpaceFUCHSIA(featureBits, rootType,
                                  (const VkSysmemColorSpaceFUCHSIA*)(toCount->pColorSpaces), count);
}
  ...
  if (toCount) {
    for (uint32_t i = 0; i < (uint32_t)toCount->formatConstraintsCount; ++i) {
      count_VkImageFormatConstraintsInfoFUCHSIA(
          featureBits, rootType,
          (const VkImageFormatConstraintsInfoFUCHSIA*)(toCount->pFormatConstraints + i), count);
    }
  }
  count_VkBufferCollectionConstraintsInfoFUCHSIA(
      featureBits, rootType,
...
void count_VkAccelerationStructureGeometryTrianglesDataKHR(
  ...
  *count += sizeof(VkIndexType);
  count_VkDeviceOrHostAddressConstKHR(featureBits, rootType,
                                      (VkDeviceOrHostAddressConstKHR*)(&toCount->indexData), count);
  count_VkDeviceOrHostAddressConstKHR(
...
void count_VkAccelerationStructureGeometryKHR(uint32_t featureBits, VkStructureType rootType,
  ...
  *count += sizeof(VkGeometryTypeKHR);
  count_VkAccelerationStructureGeometryDataKHR(
      featureBits, rootType, (VkAccelerationStructureGeometryDataKHR*)(&toCount->geometry), count);
  *count += sizeof(VkGeometryFlagsKHR);
}
...
void count_VkCopyAccelerationStructureToMemoryInfoKHR(
  ...
  *count += sizeof(VkStructureType);
  ...
  uint64_t cgen_var_0;
  *count += 1 * 8;
  count_VkDeviceOrHostAddressKHR(featureBits, rootType, (VkDeviceOrHostAddressKHR*)(&toCount->dst),
                                 count);
...
void count_extension_struct(uint32_t featureBits, VkStructureType rootType,
  ...
  size_t currExtSize = goldfish_vk_extension_struct_size_with_stream_features(featureBits, rootType,
                                                                              structExtension);
  ...
  switch (structType) {
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_PROPERTIES: {
      count_VkPhysicalDeviceSubgroupProperties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceSubgroupProperties*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES: {
      count_VkPhysicalDevice16BitStorageFeatures(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevice16BitStorageFeatures*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO: {
      count_VkDeviceGroupCommandBufferBeginInfo(
          featureBits, rootType,
          reinterpret_cast<const VkDeviceGroupCommandBufferBeginInfo*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO: {
      count_VkDeviceGroupSubmitInfo(
          featureBits, rootType, reinterpret_cast<const VkDeviceGroupSubmitInfo*>(structExtension),
          count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES: {
      count_VkPhysicalDevicePointClippingProperties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevicePointClippingProperties*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES: {
      count_VkPhysicalDeviceMultiviewProperties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMultiviewProperties*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES: {
      count_VkPhysicalDeviceProtectedMemoryFeatures(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceProtectedMemoryFeatures*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PROTECTED_SUBMIT_INFO: {
      count_VkProtectedSubmitInfo(featureBits, rootType,
    ...
    case VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO: {
      count_VkImagePlaneMemoryRequirementsInfo(
          featureBits, rootType,
          reinterpret_cast<const VkImagePlaneMemoryRequirementsInfo*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO: {
      count_VkPhysicalDeviceExternalImageFormatInfo(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceExternalImageFormatInfo*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO: {
      count_VkExportFenceCreateInfo(
          featureBits, rootType, reinterpret_cast<const VkExportFenceCreateInfo*>(structExtension),
          count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES: {
      count_VkPhysicalDeviceMaintenance3Properties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMaintenance3Properties*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES: {
      count_VkPhysicalDeviceVulkan11Properties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceVulkan11Properties*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES: {
      count_VkPhysicalDeviceVulkan12Properties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceVulkan12Properties*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES: {
      count_VkPhysicalDevice8BitStorageFeatures(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevice8BitStorageFeatures*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES: {
      count_VkPhysicalDeviceFloatControlsProperties(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceFloatControlsProperties*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE: {
      count_VkSubpassDescriptionDepthStencilResolve(
          featureBits, rootType,
          reinterpret_cast<const VkSubpassDescriptionDepthStencilResolve*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO: {
      count_VkFramebufferAttachmentsCreateInfo(
          featureBits, rootType,
          reinterpret_cast<const VkFramebufferAttachmentsCreateInfo*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT: {
      count_VkAttachmentReferenceStencilLayout(
          featureBits, rootType,
          reinterpret_cast<const VkAttachmentReferenceStencilLayout*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT: {
      count_VkAttachmentDescriptionStencilLayout(
          featureBits, rootType,
          reinterpret_cast<const VkAttachmentDescriptionStencilLayout*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES: {
      count_VkPhysicalDeviceHostQueryResetFeatures(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceHostQueryResetFeatures*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO: {
      count_VkBufferOpaqueCaptureAddressCreateInfo(
          featureBits, rootType,
          reinterpret_cast<const VkBufferOpaqueCaptureAddressCreateInfo*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR: {
      count_VkDeviceGroupSwapchainCreateInfoKHR(
          featureBits, rootType,
          reinterpret_cast<const VkDeviceGroupSwapchainCreateInfoKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_display_swapchain
    case VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR: {
      count_VkDisplayPresentInfoKHR(
          featureBits, rootType, reinterpret_cast<const VkDisplayPresentInfoKHR*>(structExtension),
          count);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_VIDEO_PROFILE_KHR: {
      count_VkVideoProfileKHR(featureBits, rootType,
                              reinterpret_cast<const VkVideoProfileKHR*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_VIDEO_PROFILES_KHR: {
      count_VkVideoProfilesKHR(featureBits, rootType,
                               reinterpret_cast<const VkVideoProfilesKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_dynamic_rendering
    ...
    case VK_STRUCTURE_TYPE_MULTIVIEW_PER_VIEW_ATTRIBUTES_INFO_NVX: {
      count_VkMultiviewPerViewAttributesInfoNVX(
          featureBits, rootType,
          reinterpret_cast<const VkMultiviewPerViewAttributesInfoNVX*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_external_memory_win32
    ...
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR: {
      count_VkImportMemoryFdInfoKHR(
          featureBits, rootType, reinterpret_cast<const VkImportMemoryFdInfoKHR*>(structExtension),
          count);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR: {
      count_VkWin32KeyedMutexAcquireReleaseInfoKHR(
          featureBits, rootType,
          reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_external_semaphore_win32
    case VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR: {
      count_VkExportSemaphoreWin32HandleInfoKHR(
          featureBits, rootType,
          reinterpret_cast<const VkExportSemaphoreWin32HandleInfoKHR*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR: {
      count_VkSharedPresentSurfaceCapabilitiesKHR(
          featureBits, rootType,
          reinterpret_cast<const VkSharedPresentSurfaceCapabilitiesKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_external_fence_win32
    ...
    case VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR: {
      count_VkQueryPoolPerformanceCreateInfoKHR(
          featureBits, rootType,
          reinterpret_cast<const VkQueryPoolPerformanceCreateInfoKHR*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR: {
      count_VkPhysicalDeviceShaderClockFeaturesKHR(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderClockFeaturesKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_shader_terminate_invocation
    ...
    case VK_STRUCTURE_TYPE_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR: {
      count_VkFragmentShadingRateAttachmentInfoKHR(
          featureBits, rootType,
          reinterpret_cast<const VkFragmentShadingRateAttachmentInfoKHR*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_FEATURES_KHR: {
      count_VkPhysicalDevicePresentWaitFeaturesKHR(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevicePresentWaitFeaturesKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_pipeline_executable_properties
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_FEATURES_KHR: {
      count_VkPhysicalDevicePresentIdFeaturesKHR(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevicePresentIdFeaturesKHR*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_video_encode_queue
    ...
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_2_NV: {
      count_VkQueueFamilyCheckpointProperties2NV(
          featureBits, rootType,
          reinterpret_cast<const VkQueueFamilyCheckpointProperties2NV*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_KHR_shader_subgroup_uniform_control_flow
    ...
    case VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_3_KHR: {
      count_VkFormatProperties3KHR(featureBits, rootType,
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES_KHR: {
      count_VkPhysicalDeviceMaintenance4FeaturesKHR(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMaintenance4FeaturesKHR*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_NATIVE_BUFFER_ANDROID: {
      count_VkNativeBufferANDROID(featureBits, rootType,
    ...
    case VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT: {
      count_VkDebugReportCallbackCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkDebugReportCallbackCreateInfoEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_AMD_rasterization_order
    ...
    case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_IMAGE_CREATE_INFO_NV: {
      count_VkDedicatedAllocationImageCreateInfoNV(
          featureBits, rootType,
          reinterpret_cast<const VkDedicatedAllocationImageCreateInfoNV*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_DEDICATED_ALLOCATION_BUFFER_CREATE_INFO_NV: {
      count_VkDedicatedAllocationBufferCreateInfoNV(
          featureBits, rootType,
          reinterpret_cast<const VkDedicatedAllocationBufferCreateInfoNV*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_CREATE_INFO_EXT: {
      count_VkVideoEncodeH264SessionCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkVideoEncodeH264SessionCreateInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_CREATE_INFO_EXT: {
      count_VkVideoEncodeH265SessionCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkVideoEncodeH265SessionCreateInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_CREATE_INFO_EXT: {
      count_VkVideoDecodeH264SessionCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkVideoDecodeH264SessionCreateInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_MVC_EXT: {
      count_VkVideoDecodeH264MvcEXT(
          featureBits, rootType, reinterpret_cast<const VkVideoDecodeH264MvcEXT*>(structExtension),
          count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD: {
      count_VkTextureLODGatherFormatPropertiesAMD(
          featureBits, rootType,
          reinterpret_cast<const VkTextureLODGatherFormatPropertiesAMD*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_NV_corner_sampled_image
    ...
    case VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV: {
      count_VkWin32KeyedMutexAcquireReleaseInfoNV(
          featureBits, rootType,
          reinterpret_cast<const VkWin32KeyedMutexAcquireReleaseInfoNV*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_validation_flags
    case VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT: {
      count_VkValidationFlagsEXT(featureBits, rootType,
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ASTC_DECODE_FEATURES_EXT: {
      count_VkPhysicalDeviceASTCDecodeFeaturesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceASTCDecodeFeaturesEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_conditional_rendering
    ...
    case VK_STRUCTURE_TYPE_PRESENT_TIMES_INFO_GOOGLE: {
      count_VkPresentTimesInfoGOOGLE(
          featureBits, rootType, reinterpret_cast<const VkPresentTimesInfoGOOGLE*>(structExtension),
          count);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT: {
      count_VkDebugUtilsMessengerCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkDebugUtilsMessengerCreateInfoEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_ANDROID_external_memory_android_hardware_buffer
    case VK_STRUCTURE_TYPE_ANDROID_HARDWARE_BUFFER_USAGE_ANDROID: {
      count_VkAndroidHardwareBufferUsageANDROID(
          featureBits, rootType,
          reinterpret_cast<const VkAndroidHardwareBufferUsageANDROID*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_ANDROID: {
      count_VkExternalFormatANDROID(
          featureBits, rootType, reinterpret_cast<const VkExternalFormatANDROID*>(structExtension),
          count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT: {
      count_VkSampleLocationsInfoEXT(
          featureBits, rootType, reinterpret_cast<const VkSampleLocationsInfoEXT*>(structExtension),
          count);
      break;
    }
    case VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT: {
      count_VkRenderPassSampleLocationsBeginInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkRenderPassSampleLocationsBeginInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_EXT: {
      count_VkDrmFormatModifierPropertiesListEXT(
          featureBits, rootType,
          reinterpret_cast<const VkDrmFormatModifierPropertiesListEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_2_EXT: {
      count_VkDrmFormatModifierPropertiesList2EXT(
          featureBits, rootType,
          reinterpret_cast<const VkDrmFormatModifierPropertiesList2EXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_validation_cache
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PROPERTIES_NV: {
      count_VkPhysicalDeviceRayTracingPropertiesNV(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceRayTracingPropertiesNV*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_NV_representative_fragment_test
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD: {
      count_VkPipelineCompilerControlCreateInfoAMD(
          featureBits, rootType,
          reinterpret_cast<const VkPipelineCompilerControlCreateInfoAMD*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_AMD_shader_core_properties
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD: {
      count_VkPhysicalDeviceShaderCorePropertiesAMD(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceShaderCorePropertiesAMD*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_video_decode_h265
    ...
    case VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_CREATE_INFO_EXT: {
      count_VkVideoDecodeH265SessionCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkVideoDecodeH265SessionCreateInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PRESENT_FRAME_TOKEN_GGP: {
      count_VkPresentFrameTokenGGP(featureBits, rootType,
    ...
    case VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO_EXT: {
      count_VkPipelineCreationFeedbackCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPipelineCreationFeedbackCreateInfoEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_NV_compute_shader_derivatives
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV: {
      count_VkPhysicalDeviceMeshShaderFeaturesNV(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMeshShaderFeaturesNV*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV: {
      count_VkPhysicalDeviceMeshShaderPropertiesNV(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMeshShaderPropertiesNV*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_NV_fragment_shader_barycentric
    ...
    case VK_STRUCTURE_TYPE_QUEUE_FAMILY_CHECKPOINT_PROPERTIES_NV: {
      count_VkQueueFamilyCheckpointPropertiesNV(
          featureBits, rootType,
          reinterpret_cast<const VkQueueFamilyCheckpointPropertiesNV*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_INTEL_shader_integer_functions2
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PCI_BUS_INFO_PROPERTIES_EXT: {
      count_VkPhysicalDevicePCIBusInfoPropertiesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevicePCIBusInfoPropertiesEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_AMD_display_native_hdr
    ...
    case VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_CREATE_INFO_EXT: {
      switch (rootType) {
        ...
        case VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO: {
          count_VkImportBufferGOOGLE(featureBits, rootType,
    ...
    case VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO_EXT: {
      count_VkBufferDeviceAddressCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkBufferDeviceAddressCreateInfoEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_validation_features
    case VK_STRUCTURE_TYPE_VALIDATION_FEATURES_EXT: {
      count_VkValidationFeaturesEXT(
          featureBits, rootType, reinterpret_cast<const VkValidationFeaturesEXT*>(structExtension),
          count);
      break;
    }
#endif
    ...
    case VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_INFO_EXT: {
      count_VkSurfaceFullScreenExclusiveInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkSurfaceFullScreenExclusiveInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_RENDER_PASS_TRANSFORM_BEGIN_INFO_QCOM: {
      count_VkRenderPassTransformBeginInfoQCOM(
          featureBits, rootType,
          reinterpret_cast<const VkRenderPassTransformBeginInfoQCOM*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT: {
      count_VkDeviceDeviceMemoryReportCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkDeviceDeviceMemoryReportCreateInfoEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_robustness2
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT: {
      count_VkPhysicalDeviceRobustness2FeaturesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceRobustness2FeaturesEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT: {
      count_VkSamplerCustomBorderColorCreateInfoEXT(
          featureBits, rootType,
          reinterpret_cast<const VkSamplerCustomBorderColorCreateInfoEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES_EXT: {
      count_VkPhysicalDevicePrivateDataFeaturesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevicePrivateDataFeaturesEXT*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_DEVICE_DIAGNOSTICS_CONFIG_CREATE_INFO_NV: {
      count_VkDeviceDiagnosticsConfigCreateInfoNV(
          featureBits, rootType,
          reinterpret_cast<const VkDeviceDiagnosticsConfigCreateInfoNV*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_NV_fragment_shading_rate_enums
    ...
    case VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_MOTION_INFO_NV: {
      count_VkAccelerationStructureMotionInfoNV(
          featureBits, rootType,
          reinterpret_cast<const VkAccelerationStructureMotionInfoNV*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT: {
      count_VkPhysicalDevice4444FormatsFeaturesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDevice4444FormatsFeaturesEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_rgba10x6_formats
    ...
    case VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE: {
      count_VkMutableDescriptorTypeCreateInfoVALVE(
          featureBits, rootType,
          reinterpret_cast<const VkMutableDescriptorTypeCreateInfoVALVE*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_vertex_input_dynamic_state
    ...
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA: {
      count_VkImportMemoryZirconHandleInfoFUCHSIA(
          featureBits, rootType,
          reinterpret_cast<const VkImportMemoryZirconHandleInfoFUCHSIA*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_FUCHSIA_buffer_collection
    case VK_STRUCTURE_TYPE_IMPORT_MEMORY_BUFFER_COLLECTION_FUCHSIA: {
      count_VkImportMemoryBufferCollectionFUCHSIA(
          featureBits, rootType,
          reinterpret_cast<const VkImportMemoryBufferCollectionFUCHSIA*>(structExtension), count);
      break;
    }
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_FEATURES_EXT: {
      count_VkPhysicalDeviceMultiDrawFeaturesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMultiDrawFeaturesEXT*>(structExtension), count);
      break;
    }
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT: {
      count_VkPhysicalDeviceMultiDrawPropertiesEXT(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceMultiDrawPropertiesEXT*>(structExtension), count);
      break;
    }
#endif
#ifdef VK_EXT_border_color_swizzle
    ...
    case VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR: {
      count_VkPhysicalDeviceRayQueryFeaturesKHR(
          featureBits, rootType,
          reinterpret_cast<const VkPhysicalDeviceRayQueryFeaturesKHR*>(structExtension), count);
      break;
    }
#endif
    default: {
