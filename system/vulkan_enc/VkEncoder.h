...
#include "VkEncoder.h.inl"
  ...
  void vkGetPhysicalDeviceFormatProperties(VkPhysicalDevice physicalDevice, VkFormat format,
                                           VkFormatProperties* pFormatProperties, uint32_t doLock);
  ...
  void vkGetPhysicalDeviceMemoryProperties(VkPhysicalDevice physicalDevice,
                                           ...
                                           uint32_t doLock);
  PFN_vkVoidFunction vkGetInstanceProcAddr(VkInstance instance, const char* pName, uint32_t doLock);
  ...
  VkResult vkCreateFence(VkDevice device, const VkFenceCreateInfo* pCreateInfo,
                         const VkAllocationCallbacks* pAllocator, VkFence* pFence, uint32_t doLock);
  ...
  VkResult vkCreateEvent(VkDevice device, const VkEventCreateInfo* pCreateInfo,
                         const VkAllocationCallbacks* pAllocator, VkEvent* pEvent, uint32_t doLock);
  ...
  VkResult vkCreateImage(VkDevice device, const VkImageCreateInfo* pCreateInfo,
                         const VkAllocationCallbacks* pAllocator, VkImage* pImage, uint32_t doLock);
  ...
  VkResult vkMergePipelineCaches(VkDevice device, VkPipelineCache dstCache, uint32_t srcCacheCount,
                                 const VkPipelineCache* pSrcCaches, uint32_t doLock);
  ...
  void vkCmdClearColorImage(VkCommandBuffer commandBuffer, VkImage image, VkImageLayout imageLayout,
                            ...
                            const VkImageSubresourceRange* pRanges, uint32_t doLock);
  ...
  void vkCmdNextSubpass(VkCommandBuffer commandBuffer, VkSubpassContents contents, uint32_t doLock);
  ...
  VkResult vkAcquireNextImageKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t timeout,
                                 ...
                                 uint32_t doLock);
  VkResult vkQueuePresentKHR(VkQueue queue, const VkPresentInfoKHR* pPresentInfo, uint32_t doLock);
  ...
  VkResult vkGetDisplayModePropertiesKHR(VkPhysicalDevice physicalDevice, VkDisplayKHR display,
                                         uint32_t* pPropertyCount,
                                         VkDisplayModePropertiesKHR* pProperties, uint32_t doLock);
  ...
  VkBool32 vkGetPhysicalDeviceXcbPresentationSupportKHR(VkPhysicalDevice physicalDevice,
                                                        ...
                                                        xcb_visualid_t visual_id, uint32_t doLock);
#endif
  ...
  void vkCmdWriteTimestamp2KHR(VkCommandBuffer commandBuffer, VkPipelineStageFlags2KHR stage,
                               VkQueryPool queryPool, uint32_t query, uint32_t doLock);
  VkResult vkQueueSubmit2KHR(VkQueue queue, uint32_t submitCount, const VkSubmitInfo2KHR* pSubmits,
                             VkFence fence, uint32_t doLock);
  ...
  void vkCmdEndQueryIndexedEXT(VkCommandBuffer commandBuffer, VkQueryPool queryPool, uint32_t query,
                               uint32_t index, uint32_t doLock);
  ...
  VkResult vkGetImageViewAddressNVX(VkDevice device, VkImageView imageView,
                                    VkImageViewAddressPropertiesNVX* pProperties, uint32_t doLock);
#endif
  ...
  void vkCmdSetViewportWScalingNV(VkCommandBuffer commandBuffer, uint32_t firstViewport,
                                  ...
                                  const VkViewportWScalingNV* pViewportWScalings, uint32_t doLock);
#endif
  ...
  void vkCmdTraceRaysNV(VkCommandBuffer commandBuffer, VkBuffer raygenShaderBindingTableBuffer,
                        ...
                        uint32_t depth, uint32_t doLock);
  ...
  void vkCmdSetCullModeEXT(VkCommandBuffer commandBuffer, VkCullModeFlags cullMode,
                           uint32_t doLock);
  void vkCmdSetFrontFaceEXT(VkCommandBuffer commandBuffer, VkFrontFace frontFace, uint32_t doLock);
  ...
  void vkGetPrivateDataEXT(VkDevice device, VkObjectType objectType, uint64_t objectHandle,
                           VkPrivateDataSlotEXT privateDataSlot, uint64_t* pData, uint32_t doLock);
#endif
  ...
  VkResult vkCreateBufferCollectionFUCHSIA(VkDevice device,
                                           ...
                                           const VkAllocationCallbacks* pAllocator,
                                           VkBufferCollectionFUCHSIA* pCollection, uint32_t doLock);
  ...
  VkBool32 vkGetPhysicalDeviceScreenPresentationSupportQNX(VkPhysicalDevice physicalDevice,
                                                           uint32_t queueFamilyIndex,
                                                           _screen_window* window, uint32_t doLock);
#endif
  ...
  VkResult vkRegisterImageColorBufferGOOGLE(VkDevice device, VkImage image, uint32_t colorBuffer,
                                            uint32_t doLock);
  VkResult vkRegisterBufferColorBufferGOOGLE(VkDevice device, VkBuffer buffer, uint32_t colorBuffer,
                                             uint32_t doLock);
